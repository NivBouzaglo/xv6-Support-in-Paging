...
main(int argc, char **argv)
{
  ...
  4c:	91858593          	addi	a1,a1,-1768 # 960 <ustack_free+0x84>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	5b050513          	addi	a0,a0,1456 # 980 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a0:	4e4b8b93          	addi	s7,s7,1252 # 980 <digits>
 ...
 5e0:	39c90913          	addi	s2,s2,924 # 978 <ustack_free+0x9c>
        while(*s != 0){
...
0000000000000806 <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 806:	20000793          	li	a5,512
 80a:	0ca7e763          	bltu	a5,a0,8d8 <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 ...
 81e:	7ee7b783          	ld	a5,2030(a5) # 1008 <head>
 822:	c7b1                	beqz	a5,86e <ustack_malloc+0x68>
 ...
 824:	43d8                	lw	a4,4(a5)
 826:	02051693          	slli	a3,a0,0x20
 82a:	9281                	srli	a3,a3,0x20
 82c:	06c1                	addi	a3,a3,16
 82e:	02071613          	slli	a2,a4,0x20
 832:	9201                	srli	a2,a2,0x20
 834:	06d66563          	bltu	a2,a3,89e <ustack_malloc+0x98>
        else{
 ...
 838:	0007e683          	lwu	a3,0(a5)
 83c:	01078613          	addi	a2,a5,16
 840:	96b2                	add	a3,a3,a2
 842:	00000617          	auipc	a2,0x0
 846:	7c660613          	addi	a2,a2,1990 # 1008 <head>
 84a:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 84c:	3741                	addiw	a4,a4,-16
 84e:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 850:	c2d8                	sw	a4,4(a3)
            head->len = len;
 852:	6218                	ld	a4,0(a2)
 ...
 85e:	7ae53503          	ld	a0,1966(a0) # 1008 <head>
 862:	0541                	addi	a0,a0,16
}
 864:	60e2                	ld	ra,24(sp)
 866:	6442                	ld	s0,16(sp)
 868:	64a2                	ld	s1,8(sp)
 86a:	6105                	addi	sp,sp,32
 86c:	8082                	ret
        address = (uint64)sbrk(4096);
 86e:	6505                	lui	a0,0x1
 870:	00000097          	auipc	ra,0x0
 874:	b04080e7          	jalr	-1276(ra) # 374 <sbrk>
        if(address == -1)//valid
 878:	57fd                	li	a5,-1
 87a:	fef505e3          	beq	a0,a5,864 <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 87e:	00000797          	auipc	a5,0x0
 882:	78a78793          	addi	a5,a5,1930 # 1008 <head>
 886:	e388                	sd	a0,0(a5)
        head->len = len;
 888:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 88a:	6398                	ld	a4,0(a5)
 88c:	6505                	lui	a0,0x1
 88e:	3541                	addiw	a0,a0,-16
 890:	409504bb          	subw	s1,a0,s1
 894:	c344                	sw	s1,4(a4)
        head->prev = 0;
 896:	639c                	ld	a5,0(a5)
 898:	0007b423          	sd	zero,8(a5)
 89c:	bf7d                	j	85a <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 89e:	6505                	lui	a0,0x1
 8a0:	00000097          	auipc	ra,0x0
 8a4:	ad4080e7          	jalr	-1324(ra) # 374 <sbrk>
            if(address == -1)//valid
 8a8:	57fd                	li	a5,-1
 8aa:	faf50de3          	beq	a0,a5,864 <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 8ae:	00000617          	auipc	a2,0x0
 8b2:	75a60613          	addi	a2,a2,1882 # 1008 <head>
 8b6:	6218                	ld	a4,0(a2)
 8b8:	435c                	lw	a5,4(a4)
 8ba:	6685                	lui	a3,0x1
 8bc:	36c1                	addiw	a3,a3,-16
 8be:	9fb5                	addw	a5,a5,a3
 8c0:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 8c2:	00076683          	lwu	a3,0(a4)
 8c6:	01070593          	addi	a1,a4,16
 8ca:	96ae                	add	a3,a3,a1
 8cc:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
 8ce:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
 ...
 8d2:	e798                	sd	a4,8(a5)
            head->len = len;
 8d4:	c384                	sw	s1,0(a5)
 8d6:	b751                	j	85a <ustack_malloc+0x54>
        return (void*)-1;
 8d8:	557d                	li	a0,-1
}
 8da:	8082                	ret

00000000000008dc <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 8dc:	00000797          	auipc	a5,0x0
 8e0:	72c7b783          	ld	a5,1836(a5) # 1008 <head>
 8e4:	cbad                	beqz	a5,956 <ustack_free+0x7a>
int ustack_free(void){
 ...
 8f2:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 8f4:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 8f8:	02090d63          	beqz	s2,932 <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 8fc:	03479713          	slli	a4,a5,0x34
 900:	cf1d                	beqz	a4,93e <ustack_free+0x62>
        sbrk(-4096);
 ...
 908:	76fd                	lui	a3,0xfffff
 90a:	8f75                	and	a4,a4,a3
 90c:	07c1                	addi	a5,a5,16
 90e:	02049693          	slli	a3,s1,0x20
 912:	9281                	srli	a3,a3,0x20
 914:	97b6                	add	a5,a5,a3
 916:	02f76a63          	bltu	a4,a5,94a <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 91a:	00000797          	auipc	a5,0x0
 91e:	6f27b723          	sd	s2,1774(a5) # 1008 <head>
    return len;    
 922:	0004851b          	sext.w	a0,s1
 926:	60e2                	ld	ra,24(sp)
 928:	6442                	ld	s0,16(sp)
 92a:	64a2                	ld	s1,8(sp)
 92c:	6902                	ld	s2,0(sp)
 92e:	6105                	addi	sp,sp,32
 930:	8082                	ret
        sbrk(-4096);
 932:	757d                	lui	a0,0xfffff
 934:	00000097          	auipc	ra,0x0
 938:	a40080e7          	jalr	-1472(ra) # 374 <sbrk>
 93c:	bff9                	j	91a <ustack_free+0x3e>
        sbrk(-4096);
 93e:	757d                	lui	a0,0xfffff
 940:	00000097          	auipc	ra,0x0
 944:	a34080e7          	jalr	-1484(ra) # 374 <sbrk>
 948:	bfc9                	j	91a <ustack_free+0x3e>
        sbrk(-PGSIZE);
 94a:	757d                	lui	a0,0xfffff
 94c:	00000097          	auipc	ra,0x0
 950:	a28080e7          	jalr	-1496(ra) # 374 <sbrk>
 954:	b7d9                	j	91a <ustack_free+0x3e>
        return -1;
 956:	557d                	li	a0,-1
 958:	8082                	ret
