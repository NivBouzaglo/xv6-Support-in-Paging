...
ls(char *path)
{
 ...
 12c:	ad850513          	addi	a0,a0,-1320 # c00 <ustack_free+0xb0>
 ...
 16a:	a6a58593          	addi	a1,a1,-1430 # bd0 <ustack_free+0x80>
 16e:	4509                	li	a0,2
 ...
 180:	a6c58593          	addi	a1,a1,-1428 # be8 <ustack_free+0x98>
 184:	4509                	li	a0,2
 ...
 1b2:	a6250513          	addi	a0,a0,-1438 # c10 <ustack_free+0xc0>
 ...
 1f8:	a34a0a13          	addi	s4,s4,-1484 # c28 <ustack_free+0xd8>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	9eca8a93          	addi	s5,s5,-1556 # be8 <ustack_free+0x98>
...
main(int argc, char *argv[])
{
 ...
 2c2:	97a50513          	addi	a0,a0,-1670 # c38 <ustack_free+0xe8>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 648:	60450513          	addi	a0,a0,1540 # c48 <digits>
 64c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 714:	538b8b93          	addi	s7,s7,1336 # c48 <digits>
 ...
 854:	3f090913          	addi	s2,s2,1008 # c40 <ustack_free+0xf0>
        while(*s != 0){
...
0000000000000a7a <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 a7a:	20000793          	li	a5,512
 a7e:	0ca7e763          	bltu	a5,a0,b4c <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 ...
 a92:	57a7b783          	ld	a5,1402(a5) # 1008 <head>
 a96:	c7b1                	beqz	a5,ae2 <ustack_malloc+0x68>
 ...
 a98:	43d8                	lw	a4,4(a5)
 a9a:	02051693          	slli	a3,a0,0x20
 a9e:	9281                	srli	a3,a3,0x20
 aa0:	06c1                	addi	a3,a3,16
 aa2:	02071613          	slli	a2,a4,0x20
 aa6:	9201                	srli	a2,a2,0x20
 aa8:	06d66563          	bltu	a2,a3,b12 <ustack_malloc+0x98>
        else{
 ...
 aac:	0007e683          	lwu	a3,0(a5)
 ab0:	01078613          	addi	a2,a5,16
 ab4:	96b2                	add	a3,a3,a2
 ab6:	00000617          	auipc	a2,0x0
 aba:	55260613          	addi	a2,a2,1362 # 1008 <head>
 abe:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 ac0:	3741                	addiw	a4,a4,-16
 ac2:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 ac4:	c2d8                	sw	a4,4(a3)
            head->len = len;
 ac6:	6218                	ld	a4,0(a2)
 ...
 ad2:	53a53503          	ld	a0,1338(a0) # 1008 <head>
 ...
 ae8:	b04080e7          	jalr	-1276(ra) # 5e8 <sbrk>
        if(address == -1)//valid
 aec:	57fd                	li	a5,-1
 aee:	fef505e3          	beq	a0,a5,ad8 <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 af2:	00000797          	auipc	a5,0x0
 af6:	51678793          	addi	a5,a5,1302 # 1008 <head>
 afa:	e388                	sd	a0,0(a5)
        head->len = len;
 afc:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 afe:	6398                	ld	a4,0(a5)
 b00:	6505                	lui	a0,0x1
 b02:	3541                	addiw	a0,a0,-16
 b04:	409504bb          	subw	s1,a0,s1
 b08:	c344                	sw	s1,4(a4)
        head->prev = 0;
 b0a:	639c                	ld	a5,0(a5)
 b0c:	0007b423          	sd	zero,8(a5)
 b10:	bf7d                	j	ace <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 b12:	6505                	lui	a0,0x1
 b14:	00000097          	auipc	ra,0x0
 b18:	ad4080e7          	jalr	-1324(ra) # 5e8 <sbrk>
            if(address == -1)//valid
 b1c:	57fd                	li	a5,-1
 b1e:	faf50de3          	beq	a0,a5,ad8 <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 b22:	00000617          	auipc	a2,0x0
 b26:	4e660613          	addi	a2,a2,1254 # 1008 <head>
 b2a:	6218                	ld	a4,0(a2)
 b2c:	435c                	lw	a5,4(a4)
 b2e:	6685                	lui	a3,0x1
 b30:	36c1                	addiw	a3,a3,-16
 b32:	9fb5                	addw	a5,a5,a3
 b34:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 b36:	00076683          	lwu	a3,0(a4)
 b3a:	01070593          	addi	a1,a4,16
 b3e:	96ae                	add	a3,a3,a1
 b40:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
 b42:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
 ...
 b46:	e798                	sd	a4,8(a5)
            head->len = len;
 b48:	c384                	sw	s1,0(a5)
 b4a:	b751                	j	ace <ustack_malloc+0x54>
        return (void*)-1;
 b4c:	557d                	li	a0,-1
}
 b4e:	8082                	ret

0000000000000b50 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 b50:	00000797          	auipc	a5,0x0
 b54:	4b87b783          	ld	a5,1208(a5) # 1008 <head>
 b58:	cbad                	beqz	a5,bca <ustack_free+0x7a>
int ustack_free(void){
 b5a:	1101                	addi	sp,sp,-32
 ...
 b66:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 b68:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 b6c:	02090d63          	beqz	s2,ba6 <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 b70:	03479713          	slli	a4,a5,0x34
 b74:	cf1d                	beqz	a4,bb2 <ustack_free+0x62>
        sbrk(-4096);

    else if(PGROUNDUP((uint64)head) < (uint64)head + sizeof(struct ustack) + head->len)
 b76:	6705                	lui	a4,0x1
 b78:	177d                	addi	a4,a4,-1
 b7a:	973e                	add	a4,a4,a5
 b7c:	76fd                	lui	a3,0xfffff
 b7e:	8f75                	and	a4,a4,a3
 b80:	07c1                	addi	a5,a5,16
 b82:	02049693          	slli	a3,s1,0x20
 b86:	9281                	srli	a3,a3,0x20
 b88:	97b6                	add	a5,a5,a3
 b8a:	02f76a63          	bltu	a4,a5,bbe <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 b8e:	00000797          	auipc	a5,0x0
 b92:	4727bd23          	sd	s2,1146(a5) # 1008 <head>
    return len;    
 b96:	0004851b          	sext.w	a0,s1
 b9a:	60e2                	ld	ra,24(sp)
 b9c:	6442                	ld	s0,16(sp)
 b9e:	64a2                	ld	s1,8(sp)
 ba0:	6902                	ld	s2,0(sp)
 ba2:	6105                	addi	sp,sp,32
 ba4:	8082                	ret
        sbrk(-4096);
 ba6:	757d                	lui	a0,0xfffff
 ba8:	00000097          	auipc	ra,0x0
 bac:	a40080e7          	jalr	-1472(ra) # 5e8 <sbrk>
 bb0:	bff9                	j	b8e <ustack_free+0x3e>
        sbrk(-4096);
 bb2:	757d                	lui	a0,0xfffff
 bb4:	00000097          	auipc	ra,0x0
 bb8:	a34080e7          	jalr	-1484(ra) # 5e8 <sbrk>
 bbc:	bfc9                	j	b8e <ustack_free+0x3e>
        sbrk(-PGSIZE);
 bbe:	757d                	lui	a0,0xfffff
 bc0:	00000097          	auipc	ra,0x0
 bc4:	a28080e7          	jalr	-1496(ra) # 5e8 <sbrk>
 bc8:	b7d9                	j	b8e <ustack_free+0x3e>
        return -1;
 bca:	557d                	li	a0,-1
 bcc:	8082                	ret
