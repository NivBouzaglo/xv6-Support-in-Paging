...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	47650513          	addi	a0,a0,1142 # 1510 <ustack_free+0x8c>
      a2:	00001097          	auipc	ra,0x1
      a6:	e5a080e7          	jalr	-422(ra) # efc <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	46650513          	addi	a0,a0,1126 # 1510 <ustack_free+0x8c>
      b2:	00001097          	auipc	ra,0x1
      b6:	e52080e7          	jalr	-430(ra) # f04 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	45c50513          	addi	a0,a0,1116 # 1518 <ustack_free+0x94>
  ...
  chdir("/");
      ...
      da:	46250513          	addi	a0,a0,1122 # 1538 <ustack_free+0xb4>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	46298993          	addi	s3,s3,1122 # 1548 <ustack_free+0xc4>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	45098993          	addi	s3,s3,1104 # 1540 <ustack_free+0xbc>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     10e:	44650513          	addi	a0,a0,1094 # 1550 <ustack_free+0xcc>
    ...
    if(what == 1){
     ...
     2a2:	52a58593          	addi	a1,a1,1322 # 17c8 <ustack_free+0x344>
     ...
     2c6:	50e50513          	addi	a0,a0,1294 # 17d0 <ustack_free+0x34c>
     ...
     2e4:	28050513          	addi	a0,a0,640 # 1560 <ustack_free+0xdc>
     ...
     36c:	21850513          	addi	a0,a0,536 # 1580 <ustack_free+0xfc>
     ...
     38e:	20650513          	addi	a0,a0,518 # 1590 <ustack_free+0x10c>
     ...
     3c6:	18e50513          	addi	a0,a0,398 # 1550 <ustack_free+0xcc>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b32080e7          	jalr	-1230(ra) # efc <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	1d250513          	addi	a0,a0,466 # 15a8 <ustack_free+0x124>
     ...
     430:	1ac50513          	addi	a0,a0,428 # 15d8 <ustack_free+0x154>
     434:	00001097          	auipc	ra,0x1
     438:	ab0080e7          	jalr	-1360(ra) # ee4 <unlink>
     43c:	b1dd                	j	122 <go+0xaa>
      unlink("b");
     43e:	00001517          	auipc	a0,0x1
     442:	16250513          	addi	a0,a0,354 # 15a0 <ustack_free+0x11c>
     446:	00001097          	auipc	ra,0x1
     44a:	a9e080e7          	jalr	-1378(ra) # ee4 <unlink>
      link("../grindir/./../a", "../b");
     44e:	00001597          	auipc	a1,0x1
     452:	12a58593          	addi	a1,a1,298 # 1578 <ustack_free+0xf4>
     456:	00001517          	auipc	a0,0x1
     45a:	18a50513          	addi	a0,a0,394 # 15e0 <ustack_free+0x15c>
     45e:	00001097          	auipc	ra,0x1
     462:	a96080e7          	jalr	-1386(ra) # ef4 <link>
     466:	b975                	j	122 <go+0xaa>
      unlink("../grindir/../a");
     468:	00001517          	auipc	a0,0x1
     46c:	19050513          	addi	a0,a0,400 # 15f8 <ustack_free+0x174>
     470:	00001097          	auipc	ra,0x1
     474:	a74080e7          	jalr	-1420(ra) # ee4 <unlink>
      link(".././b", "/grindir/../a");
     478:	00001597          	auipc	a1,0x1
     47c:	10858593          	addi	a1,a1,264 # 1580 <ustack_free+0xfc>
     480:	00001517          	auipc	a0,0x1
     484:	18850513          	addi	a0,a0,392 # 1608 <ustack_free+0x184>
     ...
     4b8:	15c50513          	addi	a0,a0,348 # 1610 <ustack_free+0x18c>
     ...
     506:	10e50513          	addi	a0,a0,270 # 1610 <ustack_free+0x18c>
     ...
     518:	980080e7          	jalr	-1664(ra) # e94 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <ustack_free+0x2f7>
     ...
     566:	0c650513          	addi	a0,a0,198 # 1628 <ustack_free+0x1a4>
     ...
     592:	06250513          	addi	a0,a0,98 # 15f0 <ustack_free+0x16c>
     ...
     5b4:	06050513          	addi	a0,a0,96 # 1610 <ustack_free+0x18c>
     ...
     5ce:	06e50513          	addi	a0,a0,110 # 1638 <ustack_free+0x1b4>
     ...
     61c:	ff850513          	addi	a0,a0,-8 # 1610 <ustack_free+0x18c>
     ...
     678:	fdc50513          	addi	a0,a0,-36 # 1650 <ustack_free+0x1cc>
     ...
     6a4:	fc858593          	addi	a1,a1,-56 # 1668 <ustack_free+0x1e4>
     ...
     7a6:	e6e50513          	addi	a0,a0,-402 # 1610 <ustack_free+0x18c>
     ...
     7c0:	ef450513          	addi	a0,a0,-268 # 16b0 <ustack_free+0x22c>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	720080e7          	jalr	1824(ra) # ee4 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	ee050513          	addi	a0,a0,-288 # 16b0 <ustack_free+0x22c>
     ...
     7ec:	e8058593          	addi	a1,a1,-384 # 1668 <ustack_free+0x1e4>
     ...
     832:	e8250513          	addi	a0,a0,-382 # 16b0 <ustack_free+0x22c>
     836:	00000097          	auipc	ra,0x0
     83a:	6ae080e7          	jalr	1710(ra) # ee4 <unlink>
     83e:	b0d5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     840:	00001517          	auipc	a0,0x1
     844:	e7850513          	addi	a0,a0,-392 # 16b8 <ustack_free+0x234>
     ...
     85e:	e7650513          	addi	a0,a0,-394 # 16d0 <ustack_free+0x24c>
     ...
     878:	e7450513          	addi	a0,a0,-396 # 16e8 <ustack_free+0x264>
     ...
     894:	e7050513          	addi	a0,a0,-400 # 1700 <ustack_free+0x27c>
     ...
     8ae:	e7e50513          	addi	a0,a0,-386 # 1728 <ustack_free+0x2a4>
     ...
     8c8:	d8c58593          	addi	a1,a1,-628 # 1650 <ustack_free+0x1cc>
     8cc:	4509                	li	a0,2
     ...
     8e4:	d7058593          	addi	a1,a1,-656 # 1650 <ustack_free+0x1cc>
     8e8:	4509                	li	a0,2
     ...
     940:	e1458593          	addi	a1,a1,-492 # 1750 <ustack_free+0x2cc>
     944:	4509                	li	a0,2
     ...
     9b4:	c6058593          	addi	a1,a1,-928 # 1610 <ustack_free+0x18c>
     9b8:	4509                	li	a0,2
     ...
     a00:	d5458593          	addi	a1,a1,-684 # 1750 <ustack_free+0x2cc>
     a04:	4509                	li	a0,2
     ...
     a44:	d1058593          	addi	a1,a1,-752 # 1750 <ustack_free+0x2cc>
     a48:	4509                	li	a0,2
     ...
     a6c:	d3878793          	addi	a5,a5,-712 # 17a0 <ustack_free+0x31c>
     a70:	faf43423          	sd	a5,-88(s0)
     a74:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a78:	fa840593          	addi	a1,s0,-88
     a7c:	00001517          	auipc	a0,0x1
     a80:	d2c50513          	addi	a0,a0,-724 # 17a8 <ustack_free+0x324>
     a84:	00000097          	auipc	ra,0x0
     a88:	448080e7          	jalr	1096(ra) # ecc <exec>
        fprintf(2, "grind: cat: not found\n");
     a8c:	00001597          	auipc	a1,0x1
     a90:	d2458593          	addi	a1,a1,-732 # 17b0 <ustack_free+0x32c>
     a94:	4509                	li	a0,2
     ...
     aac:	b6858593          	addi	a1,a1,-1176 # 1610 <ustack_free+0x18c>
     ab0:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	b2050513          	addi	a0,a0,-1248 # 15f0 <ustack_free+0x16c>
     ad8:	00000097          	auipc	ra,0x0
     adc:	40c080e7          	jalr	1036(ra) # ee4 <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	ac050513          	addi	a0,a0,-1344 # 15a0 <ustack_free+0x11c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b1e:	af650513          	addi	a0,a0,-1290 # 1610 <ustack_free+0x18c>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     b4c:	629c                	ld	a5,0(a3)
     b4e:	6709                	lui	a4,0x2
     b50:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x409>
    ...
    printf("grind: fork failed\n");
     ...
     b66:	aae50513          	addi	a0,a0,-1362 # 1610 <ustack_free+0x18c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f7c:	88850513          	addi	a0,a0,-1912 # 1800 <digits>
     f80:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1048:	7bcb8b93          	addi	s7,s7,1980 # 1800 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1188:	67490913          	addi	s2,s2,1652 # 17f8 <ustack_free+0x374>
        while(*s != 0){
...
00000000000013ae <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
    13ae:	20000793          	li	a5,512
    13b2:	0ca7e763          	bltu	a5,a0,1480 <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
    ...
    13c6:	c567b783          	ld	a5,-938(a5) # 2018 <head>
    13ca:	c7b1                	beqz	a5,1416 <ustack_malloc+0x68>
    ...
    13cc:	43d8                	lw	a4,4(a5)
    13ce:	02051693          	slli	a3,a0,0x20
    13d2:	9281                	srli	a3,a3,0x20
    13d4:	06c1                	addi	a3,a3,16
    13d6:	02071613          	slli	a2,a4,0x20
    13da:	9201                	srli	a2,a2,0x20
    13dc:	06d66563          	bltu	a2,a3,1446 <ustack_malloc+0x98>
        else{
    ...
    13e0:	0007e683          	lwu	a3,0(a5)
    13e4:	01078613          	addi	a2,a5,16
    13e8:	96b2                	add	a3,a3,a2
    13ea:	00001617          	auipc	a2,0x1
    13ee:	c2e60613          	addi	a2,a2,-978 # 2018 <head>
    13f2:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
    13f4:	3741                	addiw	a4,a4,-16
    13f6:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
    13f8:	c2d8                	sw	a4,4(a3)
            head->len = len;
    13fa:	6218                	ld	a4,0(a2)
    13fc:	c308                	sw	a0,0(a4)
            head->prev = next.prev;
    13fe:	6218                	ld	a4,0(a2)
    1400:	e71c                	sd	a5,8(a4)
        }
    }
    return (void*)head + sizeof(struct ustack);
    1402:	00001517          	auipc	a0,0x1
    1406:	c1653503          	ld	a0,-1002(a0) # 2018 <head>
    140a:	0541                	addi	a0,a0,16
}
    140c:	60e2                	ld	ra,24(sp)
    140e:	6442                	ld	s0,16(sp)
    1410:	64a2                	ld	s1,8(sp)
    1412:	6105                	addi	sp,sp,32
    1414:	8082                	ret
        address = (uint64)sbrk(4096);
    1416:	6505                	lui	a0,0x1
    1418:	00000097          	auipc	ra,0x0
    141c:	b04080e7          	jalr	-1276(ra) # f1c <sbrk>
        if(address == -1)//valid
    1420:	57fd                	li	a5,-1
    1422:	fef505e3          	beq	a0,a5,140c <ustack_malloc+0x5e>
        head = (struct ustack*) address;
    1426:	00001797          	auipc	a5,0x1
    142a:	bf278793          	addi	a5,a5,-1038 # 2018 <head>
    142e:	e388                	sd	a0,0(a5)
        head->len = len;
    1430:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
    1432:	6398                	ld	a4,0(a5)
    1434:	6505                	lui	a0,0x1
    1436:	3541                	addiw	a0,a0,-16
    1438:	409504bb          	subw	s1,a0,s1
    143c:	c344                	sw	s1,4(a4)
        head->prev = 0;
    143e:	639c                	ld	a5,0(a5)
    1440:	0007b423          	sd	zero,8(a5)
    1444:	bf7d                	j	1402 <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
    1446:	6505                	lui	a0,0x1
    1448:	00000097          	auipc	ra,0x0
    144c:	ad4080e7          	jalr	-1324(ra) # f1c <sbrk>
            if(address == -1)//valid
    1450:	57fd                	li	a5,-1
    1452:	faf50de3          	beq	a0,a5,140c <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
    1456:	00001617          	auipc	a2,0x1
    145a:	bc260613          	addi	a2,a2,-1086 # 2018 <head>
    145e:	6218                	ld	a4,0(a2)
    1460:	435c                	lw	a5,4(a4)
    1462:	6685                	lui	a3,0x1
    1464:	36c1                	addiw	a3,a3,-16
    1466:	9fb5                	addw	a5,a5,a3
    1468:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
    146a:	00076683          	lwu	a3,0(a4)
    146e:	01070593          	addi	a1,a4,16
    1472:	96ae                	add	a3,a3,a1
    1474:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
    1476:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
    1478:	621c                	ld	a5,0(a2)
    147a:	e798                	sd	a4,8(a5)
            head->len = len;
    147c:	c384                	sw	s1,0(a5)
    147e:	b751                	j	1402 <ustack_malloc+0x54>
        return (void*)-1;
    1480:	557d                	li	a0,-1
}
    1482:	8082                	ret

0000000000001484 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
    1484:	00001797          	auipc	a5,0x1
    1488:	b947b783          	ld	a5,-1132(a5) # 2018 <head>
    148c:	cbad                	beqz	a5,14fe <ustack_free+0x7a>
int ustack_free(void){
    148e:	1101                	addi	sp,sp,-32
    1490:	ec06                	sd	ra,24(sp)
    1492:	e822                	sd	s0,16(sp)
    1494:	e426                	sd	s1,8(sp)
    1496:	e04a                	sd	s2,0(sp)
    1498:	1000                	addi	s0,sp,32
        return -1;
    }
    uint len = head->len;
    149a:	4384                	lw	s1,0(a5)
    newHead = head->prev;
    149c:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
    14a0:	02090d63          	beqz	s2,14da <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
    14a4:	03479713          	slli	a4,a5,0x34
    14a8:	cf1d                	beqz	a4,14e6 <ustack_free+0x62>
        sbrk(-4096);

    else if(PGROUNDUP((uint64)head) < (uint64)head + sizeof(struct ustack) + head->len)
    14aa:	6705                	lui	a4,0x1
    14ac:	177d                	addi	a4,a4,-1
    14ae:	973e                	add	a4,a4,a5
    14b0:	76fd                	lui	a3,0xfffff
    14b2:	8f75                	and	a4,a4,a3
    14b4:	07c1                	addi	a5,a5,16
    14b6:	02049693          	slli	a3,s1,0x20
    14ba:	9281                	srli	a3,a3,0x20
    14bc:	97b6                	add	a5,a5,a3
    14be:	02f76a63          	bltu	a4,a5,14f2 <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
    14c2:	00001797          	auipc	a5,0x1
    14c6:	b527bb23          	sd	s2,-1194(a5) # 2018 <head>
    return len;    
    14ca:	0004851b          	sext.w	a0,s1
    ...
    14d8:	8082                	ret
        sbrk(-4096);
    14da:	757d                	lui	a0,0xfffff
    14dc:	00000097          	auipc	ra,0x0
    14e0:	a40080e7          	jalr	-1472(ra) # f1c <sbrk>
    14e4:	bff9                	j	14c2 <ustack_free+0x3e>
        sbrk(-4096);
    14e6:	757d                	lui	a0,0xfffff
    14e8:	00000097          	auipc	ra,0x0
    14ec:	a34080e7          	jalr	-1484(ra) # f1c <sbrk>
    14f0:	bfc9                	j	14c2 <ustack_free+0x3e>
        sbrk(-PGSIZE);
    14f2:	757d                	lui	a0,0xfffff
    14f4:	00000097          	auipc	ra,0x0
    14f8:	a28080e7          	jalr	-1496(ra) # f1c <sbrk>
    14fc:	b7d9                	j	14c2 <ustack_free+0x3e>
        return -1;
    14fe:	557d                	li	a0,-1
    1500:	8082                	ret
