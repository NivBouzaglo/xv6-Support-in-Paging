...
main(int argc, char *argv[])
{
  ...
  1a:	a2a78793          	addi	a5,a5,-1494 # a40 <ustack_free+0xbc>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	9e450513          	addi	a0,a0,-1564 # a10 <ustack_free+0x8c>
  ...
  6c:	9c050513          	addi	a0,a0,-1600 # a28 <ustack_free+0xa4>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	98250513          	addi	a0,a0,-1662 # a38 <ustack_free+0xb4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47c:	5e050513          	addi	a0,a0,1504 # a58 <digits>
 480:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 548:	514b8b93          	addi	s7,s7,1300 # a58 <digits>
 ...
 688:	3cc90913          	addi	s2,s2,972 # a50 <ustack_free+0xcc>
        while(*s != 0){
...
00000000000008ae <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 8ae:	20000793          	li	a5,512
 8b2:	0ca7e763          	bltu	a5,a0,980 <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 ...
 8c6:	7467b783          	ld	a5,1862(a5) # 1008 <head>
 8ca:	c7b1                	beqz	a5,916 <ustack_malloc+0x68>
 ...
 8cc:	43d8                	lw	a4,4(a5)
 8ce:	02051693          	slli	a3,a0,0x20
 8d2:	9281                	srli	a3,a3,0x20
 8d4:	06c1                	addi	a3,a3,16
 8d6:	02071613          	slli	a2,a4,0x20
 8da:	9201                	srli	a2,a2,0x20
 8dc:	06d66563          	bltu	a2,a3,946 <ustack_malloc+0x98>
        else{
 ...
 8e0:	0007e683          	lwu	a3,0(a5)
 8e4:	01078613          	addi	a2,a5,16
 8e8:	96b2                	add	a3,a3,a2
 8ea:	00000617          	auipc	a2,0x0
 8ee:	71e60613          	addi	a2,a2,1822 # 1008 <head>
 8f2:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 8f4:	3741                	addiw	a4,a4,-16
 8f6:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 8f8:	c2d8                	sw	a4,4(a3)
            head->len = len;
 8fa:	6218                	ld	a4,0(a2)
 ...
 906:	70653503          	ld	a0,1798(a0) # 1008 <head>
 ...
 91c:	b04080e7          	jalr	-1276(ra) # 41c <sbrk>
        if(address == -1)//valid
 920:	57fd                	li	a5,-1
 922:	fef505e3          	beq	a0,a5,90c <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 926:	00000797          	auipc	a5,0x0
 92a:	6e278793          	addi	a5,a5,1762 # 1008 <head>
 92e:	e388                	sd	a0,0(a5)
        head->len = len;
 930:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 932:	6398                	ld	a4,0(a5)
 934:	6505                	lui	a0,0x1
 936:	3541                	addiw	a0,a0,-16
 938:	409504bb          	subw	s1,a0,s1
 93c:	c344                	sw	s1,4(a4)
        head->prev = 0;
 93e:	639c                	ld	a5,0(a5)
 940:	0007b423          	sd	zero,8(a5)
 944:	bf7d                	j	902 <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 946:	6505                	lui	a0,0x1
 ...
 94c:	ad4080e7          	jalr	-1324(ra) # 41c <sbrk>
            if(address == -1)//valid
 950:	57fd                	li	a5,-1
 952:	faf50de3          	beq	a0,a5,90c <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 956:	00000617          	auipc	a2,0x0
 95a:	6b260613          	addi	a2,a2,1714 # 1008 <head>
 95e:	6218                	ld	a4,0(a2)
 960:	435c                	lw	a5,4(a4)
 962:	6685                	lui	a3,0x1
 964:	36c1                	addiw	a3,a3,-16
 966:	9fb5                	addw	a5,a5,a3
 968:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 96a:	00076683          	lwu	a3,0(a4)
 96e:	01070593          	addi	a1,a4,16
 972:	96ae                	add	a3,a3,a1
 974:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
 976:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
 ...
 97a:	e798                	sd	a4,8(a5)
            head->len = len;
 97c:	c384                	sw	s1,0(a5)
 97e:	b751                	j	902 <ustack_malloc+0x54>
        return (void*)-1;
 980:	557d                	li	a0,-1
}
 982:	8082                	ret

0000000000000984 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 984:	00000797          	auipc	a5,0x0
 988:	6847b783          	ld	a5,1668(a5) # 1008 <head>
 98c:	cbad                	beqz	a5,9fe <ustack_free+0x7a>
int ustack_free(void){
 ...
 99a:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 99c:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 9a0:	02090d63          	beqz	s2,9da <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 9a4:	03479713          	slli	a4,a5,0x34
 9a8:	cf1d                	beqz	a4,9e6 <ustack_free+0x62>
        sbrk(-4096);

    else if(PGROUNDUP((uint64)head) < (uint64)head + sizeof(struct ustack) + head->len)
 9aa:	6705                	lui	a4,0x1
 9ac:	177d                	addi	a4,a4,-1
 9ae:	973e                	add	a4,a4,a5
 9b0:	76fd                	lui	a3,0xfffff
 9b2:	8f75                	and	a4,a4,a3
 9b4:	07c1                	addi	a5,a5,16
 9b6:	02049693          	slli	a3,s1,0x20
 9ba:	9281                	srli	a3,a3,0x20
 9bc:	97b6                	add	a5,a5,a3
 9be:	02f76a63          	bltu	a4,a5,9f2 <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 9c2:	00000797          	auipc	a5,0x0
 9c6:	6527b323          	sd	s2,1606(a5) # 1008 <head>
    return len;    
 9ca:	0004851b          	sext.w	a0,s1
 ...
 9d8:	8082                	ret
        sbrk(-4096);
 9da:	757d                	lui	a0,0xfffff
 9dc:	00000097          	auipc	ra,0x0
 9e0:	a40080e7          	jalr	-1472(ra) # 41c <sbrk>
 9e4:	bff9                	j	9c2 <ustack_free+0x3e>
        sbrk(-4096);
 9e6:	757d                	lui	a0,0xfffff
 9e8:	00000097          	auipc	ra,0x0
 9ec:	a34080e7          	jalr	-1484(ra) # 41c <sbrk>
 9f0:	bfc9                	j	9c2 <ustack_free+0x3e>
        sbrk(-PGSIZE);
 9f2:	757d                	lui	a0,0xfffff
 9f4:	00000097          	auipc	ra,0x0
 9f8:	a28080e7          	jalr	-1496(ra) # 41c <sbrk>
 9fc:	b7d9                	j	9c2 <ustack_free+0x3e>
        return -1;
 9fe:	557d                	li	a0,-1
 a00:	8082                	ret
