...
main(int argc, char *argv[])
{
  ...
  42:	93258593          	addi	a1,a1,-1742 # 970 <ustack_free+0x80>
  46:	4509                	li	a0,2
  ...
  60:	92c58593          	addi	a1,a1,-1748 # 988 <ustack_free+0x98>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e8:	5cc50513          	addi	a0,a0,1484 # 9b0 <digits>
 3ec:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b4:	500b8b93          	addi	s7,s7,1280 # 9b0 <digits>
 ...
 5f4:	3b890913          	addi	s2,s2,952 # 9a8 <ustack_free+0xb8>
        while(*s != 0){
...
000000000000081a <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 81a:	20000793          	li	a5,512
 81e:	0ca7e763          	bltu	a5,a0,8ec <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 ...
 832:	7da7b783          	ld	a5,2010(a5) # 1008 <head>
 836:	c7b1                	beqz	a5,882 <ustack_malloc+0x68>
 ...
 838:	43d8                	lw	a4,4(a5)
 83a:	02051693          	slli	a3,a0,0x20
 83e:	9281                	srli	a3,a3,0x20
 840:	06c1                	addi	a3,a3,16
 842:	02071613          	slli	a2,a4,0x20
 846:	9201                	srli	a2,a2,0x20
 848:	06d66563          	bltu	a2,a3,8b2 <ustack_malloc+0x98>
        else{
 ...
 84c:	0007e683          	lwu	a3,0(a5)
 850:	01078613          	addi	a2,a5,16
 854:	96b2                	add	a3,a3,a2
 856:	00000617          	auipc	a2,0x0
 85a:	7b260613          	addi	a2,a2,1970 # 1008 <head>
 85e:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 860:	3741                	addiw	a4,a4,-16
 862:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 864:	c2d8                	sw	a4,4(a3)
            head->len = len;
 866:	6218                	ld	a4,0(a2)
 ...
 872:	79a53503          	ld	a0,1946(a0) # 1008 <head>
 ...
 888:	b04080e7          	jalr	-1276(ra) # 388 <sbrk>
        if(address == -1)//valid
 88c:	57fd                	li	a5,-1
 88e:	fef505e3          	beq	a0,a5,878 <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 892:	00000797          	auipc	a5,0x0
 896:	77678793          	addi	a5,a5,1910 # 1008 <head>
 89a:	e388                	sd	a0,0(a5)
        head->len = len;
 89c:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 89e:	6398                	ld	a4,0(a5)
 8a0:	6505                	lui	a0,0x1
 8a2:	3541                	addiw	a0,a0,-16
 8a4:	409504bb          	subw	s1,a0,s1
 8a8:	c344                	sw	s1,4(a4)
        head->prev = 0;
 8aa:	639c                	ld	a5,0(a5)
 8ac:	0007b423          	sd	zero,8(a5)
 8b0:	bf7d                	j	86e <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 8b2:	6505                	lui	a0,0x1
 8b4:	00000097          	auipc	ra,0x0
 8b8:	ad4080e7          	jalr	-1324(ra) # 388 <sbrk>
            if(address == -1)//valid
 8bc:	57fd                	li	a5,-1
 8be:	faf50de3          	beq	a0,a5,878 <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 8c2:	00000617          	auipc	a2,0x0
 8c6:	74660613          	addi	a2,a2,1862 # 1008 <head>
 8ca:	6218                	ld	a4,0(a2)
 8cc:	435c                	lw	a5,4(a4)
 8ce:	6685                	lui	a3,0x1
 8d0:	36c1                	addiw	a3,a3,-16
 8d2:	9fb5                	addw	a5,a5,a3
 8d4:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 8d6:	00076683          	lwu	a3,0(a4)
 8da:	01070593          	addi	a1,a4,16
 8de:	96ae                	add	a3,a3,a1
 8e0:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
 8e2:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
 ...
 8e6:	e798                	sd	a4,8(a5)
            head->len = len;
 8e8:	c384                	sw	s1,0(a5)
 8ea:	b751                	j	86e <ustack_malloc+0x54>
        return (void*)-1;
 8ec:	557d                	li	a0,-1
}
 8ee:	8082                	ret

00000000000008f0 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 8f0:	00000797          	auipc	a5,0x0
 8f4:	7187b783          	ld	a5,1816(a5) # 1008 <head>
 8f8:	cbad                	beqz	a5,96a <ustack_free+0x7a>
int ustack_free(void){
 ...
 906:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 908:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 90c:	02090d63          	beqz	s2,946 <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 910:	03479713          	slli	a4,a5,0x34
 914:	cf1d                	beqz	a4,952 <ustack_free+0x62>
        sbrk(-4096);

    else if(PGROUNDUP((uint64)head) < (uint64)head + sizeof(struct ustack) + head->len)
 916:	6705                	lui	a4,0x1
 918:	177d                	addi	a4,a4,-1
 91a:	973e                	add	a4,a4,a5
 91c:	76fd                	lui	a3,0xfffff
 91e:	8f75                	and	a4,a4,a3
 920:	07c1                	addi	a5,a5,16
 922:	02049693          	slli	a3,s1,0x20
 926:	9281                	srli	a3,a3,0x20
 928:	97b6                	add	a5,a5,a3
 92a:	02f76a63          	bltu	a4,a5,95e <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 92e:	00000797          	auipc	a5,0x0
 932:	6d27bd23          	sd	s2,1754(a5) # 1008 <head>
    return len;    
 936:	0004851b          	sext.w	a0,s1
 ...
 944:	8082                	ret
        sbrk(-4096);
 946:	757d                	lui	a0,0xfffff
 948:	00000097          	auipc	ra,0x0
 94c:	a40080e7          	jalr	-1472(ra) # 388 <sbrk>
 950:	bff9                	j	92e <ustack_free+0x3e>
        sbrk(-4096);
 952:	757d                	lui	a0,0xfffff
 954:	00000097          	auipc	ra,0x0
 958:	a34080e7          	jalr	-1484(ra) # 388 <sbrk>
 95c:	bfc9                	j	92e <ustack_free+0x3e>
        sbrk(-PGSIZE);
 95e:	757d                	lui	a0,0xfffff
 960:	00000097          	auipc	ra,0x0
 964:	a28080e7          	jalr	-1496(ra) # 388 <sbrk>
 968:	b7d9                	j	92e <ustack_free+0x3e>
        return -1;
 96a:	557d                	li	a0,-1
 96c:	8082                	ret
