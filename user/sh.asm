...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	43e58593          	addi	a1,a1,1086 # 1450 <ustack_free+0x82>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	3f858593          	addi	a1,a1,1016 # 1458 <ustack_free+0x8a>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	3c650513          	addi	a0,a0,966 # 1460 <ustack_free+0x92>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	49a70713          	addi	a4,a4,1178 # 1560 <ustack_free+0x192>
    ...
    panic("runcmd");
      ...
      e4:	38850513          	addi	a0,a0,904 # 1468 <ustack_free+0x9a>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	36e58593          	addi	a1,a1,878 # 1470 <ustack_free+0xa2>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	33258593          	addi	a1,a1,818 # 1480 <ustack_free+0xb2>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	2ac50513          	addi	a0,a0,684 # 1490 <ustack_free+0xc2>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	f14b8b93          	addi	s7,s7,-236 # 14b8 <ustack_free+0xea>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	ee250513          	addi	a0,a0,-286 # 1498 <ustack_free+0xca>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	e2260613          	addi	a2,a2,-478 # 14c0 <ustack_free+0xf2>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	e12b0b13          	addi	s6,s6,-494 # 14e0 <ustack_free+0x112>
  ...
  return ret;
     ...
     70c:	dc050513          	addi	a0,a0,-576 # 14c8 <ustack_free+0xfa>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	d6650513          	addi	a0,a0,-666 # 14d0 <ustack_free+0x102>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	d4460613          	addi	a2,a2,-700 # 14e8 <ustack_free+0x11a>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	cdca0a13          	addi	s4,s4,-804 # 14f0 <ustack_free+0x122>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	cae60613          	addi	a2,a2,-850 # 14f8 <ustack_free+0x12a>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	c1060613          	addi	a2,a2,-1008 # 14c0 <ustack_free+0xf2>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	c3060613          	addi	a2,a2,-976 # 1510 <ustack_free+0x142>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	bde50513          	addi	a0,a0,-1058 # 1500 <ustack_free+0x132>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	be650513          	addi	a0,a0,-1050 # 1518 <ustack_free+0x14a>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	c1a70713          	addi	a4,a4,-998 # 1578 <ustack_free+0x1aa>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	b2660613          	addi	a2,a2,-1242 # 1530 <ustack_free+0x162>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	af858593          	addi	a1,a1,-1288 # 1538 <ustack_free+0x16a>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	6de080e7          	jalr	1758(ra) # 1128 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	a7650513          	addi	a0,a0,-1418 # 14c8 <ustack_free+0xfa>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	ad448493          	addi	s1,s1,-1324 # 1548 <ustack_free+0x17a>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	a9ea8a93          	addi	s5,s5,-1378 # 1550 <ustack_free+0x182>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec6:	6d650513          	addi	a0,a0,1750 # 1598 <digits>
     eca:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f92:	60ab8b93          	addi	s7,s7,1546 # 1598 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10d2:	4c290913          	addi	s2,s2,1218 # 1590 <ustack_free+0x1c2>
        while(*s != 0){
...
00000000000012f8 <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
    12f8:	20000793          	li	a5,512
    12fc:	0ca7e763          	bltu	a5,a0,13ca <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
    1300:	1101                	addi	sp,sp,-32
    1302:	ec06                	sd	ra,24(sp)
    1304:	e822                	sd	s0,16(sp)
    1306:	e426                	sd	s1,8(sp)
    1308:	1000                	addi	s0,sp,32
    130a:	84aa                	mv	s1,a0
        return (void*)-1;
    uint64 address;
    if(head == 0){
    130c:	00001797          	auipc	a5,0x1
    1310:	d0c7b783          	ld	a5,-756(a5) # 2018 <head>
    1314:	c7b1                	beqz	a5,1360 <ustack_malloc+0x68>
    ...
    1316:	43d8                	lw	a4,4(a5)
    1318:	02051693          	slli	a3,a0,0x20
    131c:	9281                	srli	a3,a3,0x20
    131e:	06c1                	addi	a3,a3,16
    1320:	02071613          	slli	a2,a4,0x20
    1324:	9201                	srli	a2,a2,0x20
    1326:	06d66563          	bltu	a2,a3,1390 <ustack_malloc+0x98>
        else{
    ...
    132a:	0007e683          	lwu	a3,0(a5)
    132e:	01078613          	addi	a2,a5,16
    1332:	96b2                	add	a3,a3,a2
    1334:	00001617          	auipc	a2,0x1
    1338:	ce460613          	addi	a2,a2,-796 # 2018 <head>
    133c:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
    133e:	3741                	addiw	a4,a4,-16
    1340:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
    1342:	c2d8                	sw	a4,4(a3)
            head->len = len;
    1344:	6218                	ld	a4,0(a2)
    1346:	c308                	sw	a0,0(a4)
            head->prev = next.prev;
    1348:	6218                	ld	a4,0(a2)
    134a:	e71c                	sd	a5,8(a4)
        }
    }
    return (void*)head + sizeof(struct ustack);
    134c:	00001517          	auipc	a0,0x1
    1350:	ccc53503          	ld	a0,-820(a0) # 2018 <head>
    1354:	0541                	addi	a0,a0,16
}
    1356:	60e2                	ld	ra,24(sp)
    1358:	6442                	ld	s0,16(sp)
    135a:	64a2                	ld	s1,8(sp)
    135c:	6105                	addi	sp,sp,32
    135e:	8082                	ret
        address = (uint64)sbrk(4096);
    1360:	6505                	lui	a0,0x1
    1362:	00000097          	auipc	ra,0x0
    1366:	b04080e7          	jalr	-1276(ra) # e66 <sbrk>
        if(address == -1)//valid
    136a:	57fd                	li	a5,-1
    136c:	fef505e3          	beq	a0,a5,1356 <ustack_malloc+0x5e>
        head = (struct ustack*) address;
    1370:	00001797          	auipc	a5,0x1
    1374:	ca878793          	addi	a5,a5,-856 # 2018 <head>
    1378:	e388                	sd	a0,0(a5)
        head->len = len;
    137a:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
    137c:	6398                	ld	a4,0(a5)
    137e:	6505                	lui	a0,0x1
    1380:	3541                	addiw	a0,a0,-16
    1382:	409504bb          	subw	s1,a0,s1
    1386:	c344                	sw	s1,4(a4)
        head->prev = 0;
    1388:	639c                	ld	a5,0(a5)
    138a:	0007b423          	sd	zero,8(a5)
    138e:	bf7d                	j	134c <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
    1390:	6505                	lui	a0,0x1
    1392:	00000097          	auipc	ra,0x0
    1396:	ad4080e7          	jalr	-1324(ra) # e66 <sbrk>
            if(address == -1)//valid
    139a:	57fd                	li	a5,-1
    139c:	faf50de3          	beq	a0,a5,1356 <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
    13a0:	00001617          	auipc	a2,0x1
    13a4:	c7860613          	addi	a2,a2,-904 # 2018 <head>
    13a8:	6218                	ld	a4,0(a2)
    13aa:	435c                	lw	a5,4(a4)
    13ac:	6685                	lui	a3,0x1
    13ae:	36c1                	addiw	a3,a3,-16
    13b0:	9fb5                	addw	a5,a5,a3
    13b2:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
    13b4:	00076683          	lwu	a3,0(a4)
    13b8:	01070593          	addi	a1,a4,16
    13bc:	96ae                	add	a3,a3,a1
    13be:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
    13c0:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
    13c2:	621c                	ld	a5,0(a2)
    13c4:	e798                	sd	a4,8(a5)
            head->len = len;
    13c6:	c384                	sw	s1,0(a5)
    13c8:	b751                	j	134c <ustack_malloc+0x54>
        return (void*)-1;
    13ca:	557d                	li	a0,-1
}
    13cc:	8082                	ret

00000000000013ce <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
    13ce:	00001797          	auipc	a5,0x1
    13d2:	c4a7b783          	ld	a5,-950(a5) # 2018 <head>
    13d6:	cbad                	beqz	a5,1448 <ustack_free+0x7a>
int ustack_free(void){
    13d8:	1101                	addi	sp,sp,-32
    13da:	ec06                	sd	ra,24(sp)
    13dc:	e822                	sd	s0,16(sp)
    13de:	e426                	sd	s1,8(sp)
    13e0:	e04a                	sd	s2,0(sp)
    13e2:	1000                	addi	s0,sp,32
        return -1;
    }
    uint len = head->len;
    13e4:	4384                	lw	s1,0(a5)
    newHead = head->prev;
    13e6:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
    13ea:	02090d63          	beqz	s2,1424 <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
    13ee:	03479713          	slli	a4,a5,0x34
    13f2:	cf1d                	beqz	a4,1430 <ustack_free+0x62>
        sbrk(-4096);

    else if(PGROUNDUP((uint64)head) < (uint64)head + sizeof(struct ustack) + head->len)
    13f4:	6705                	lui	a4,0x1
    13f6:	177d                	addi	a4,a4,-1
    13f8:	973e                	add	a4,a4,a5
    13fa:	76fd                	lui	a3,0xfffff
    13fc:	8f75                	and	a4,a4,a3
    13fe:	07c1                	addi	a5,a5,16
    1400:	02049693          	slli	a3,s1,0x20
    1404:	9281                	srli	a3,a3,0x20
    1406:	97b6                	add	a5,a5,a3
    1408:	02f76a63          	bltu	a4,a5,143c <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
    140c:	00001797          	auipc	a5,0x1
    1410:	c127b623          	sd	s2,-1012(a5) # 2018 <head>
    return len;    
    1414:	0004851b          	sext.w	a0,s1
    ...
    1422:	8082                	ret
        sbrk(-4096);
    1424:	757d                	lui	a0,0xfffff
    1426:	00000097          	auipc	ra,0x0
    142a:	a40080e7          	jalr	-1472(ra) # e66 <sbrk>
    142e:	bff9                	j	140c <ustack_free+0x3e>
        sbrk(-4096);
    1430:	757d                	lui	a0,0xfffff
    1432:	00000097          	auipc	ra,0x0
    1436:	a34080e7          	jalr	-1484(ra) # e66 <sbrk>
    143a:	bfc9                	j	140c <ustack_free+0x3e>
        sbrk(-PGSIZE);
    143c:	757d                	lui	a0,0xfffff
    143e:	00000097          	auipc	ra,0x0
    1442:	a28080e7          	jalr	-1496(ra) # e66 <sbrk>
    1446:	b7d9                	j	140c <ustack_free+0x3e>
        return -1;
    1448:	557d                	li	a0,-1
    144a:	8082                	ret
