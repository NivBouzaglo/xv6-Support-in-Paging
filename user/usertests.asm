...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	22250513          	addi	a0,a0,546 # 6260 <ustack_free+0xaa>
      ...
      74:	8082                	ret
{
      ...
      84:	20050513          	addi	a0,a0,512 # 6280 <ustack_free+0xca>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	1f050513          	addi	a0,a0,496 # 6298 <ustack_free+0xe2>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	1f250513          	addi	a0,a0,498 # 62b8 <ustack_free+0x102>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	1ba50513          	addi	a0,a0,442 # 62a0 <ustack_free+0xea>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	1c650513          	addi	a0,a0,454 # 62c8 <ustack_free+0x112>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	1c450513          	addi	a0,a0,452 # 62f0 <ustack_free+0x13a>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	1b050513          	addi	a0,a0,432 # 62f0 <ustack_free+0x13a>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	1ac58593          	addi	a1,a1,428 # 6300 <ustack_free+0x14a>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	18850513          	addi	a0,a0,392 # 62f0 <ustack_free+0x13a>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	18c58593          	addi	a1,a1,396 # 6308 <ustack_free+0x152>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	15c50513          	addi	a0,a0,348 # 62f0 <ustack_free+0x13a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	14650513          	addi	a0,a0,326 # 6310 <ustack_free+0x15a>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	0bc50513          	addi	a0,a0,188 # 6338 <ustack_free+0x182>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	0a8a8a93          	addi	s5,s5,168 # 6338 <ustack_free+0x182>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	03650513          	addi	a0,a0,54 # 6348 <ustack_free+0x192>
     ...
     33a:	03250513          	addi	a0,a0,50 # 6368 <ustack_free+0x1b2>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	02050513          	addi	a0,a0,32 # 6380 <ustack_free+0x1ca>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	00c98993          	addi	s3,s3,12 # 6380 <ustack_free+0x1ca>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	fc050513          	addi	a0,a0,-64 # 6380 <ustack_free+0x1ca>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	f3058593          	addi	a1,a1,-208 # 6308 <ustack_free+0x152>
    ...
    printf("write failed\n");
     ...
     3f2:	fb250513          	addi	a0,a0,-78 # 63a0 <ustack_free+0x1ea>
    ...
    exit(1);
     ...
     40c:	f8050513          	addi	a0,a0,-128 # 6388 <ustack_free+0x1d2>
    ...
    printf("open junk failed\n");
     ...
     426:	f6650513          	addi	a0,a0,-154 # 6388 <ustack_free+0x1d2>
  ...
  unlink("junk");
     ...
     44a:	f3a50513          	addi	a0,a0,-198 # 6380 <ustack_free+0x1ca>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	e5ea0a13          	addi	s4,s4,-418 # 63b0 <ustack_free+0x1fa>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	dba50513          	addi	a0,a0,-582 # 63b8 <ustack_free+0x202>
     ...
     620:	db450513          	addi	a0,a0,-588 # 63d0 <ustack_free+0x21a>
     ...
     63e:	dc650513          	addi	a0,a0,-570 # 6400 <ustack_free+0x24a>
     ...
     658:	ddc50513          	addi	a0,a0,-548 # 6430 <ustack_free+0x27a>
     ...
     676:	dce50513          	addi	a0,a0,-562 # 6440 <ustack_free+0x28a>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	dc0a0a13          	addi	s4,s4,-576 # 6470 <ustack_free+0x2ba>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	c50a8a93          	addi	s5,s5,-944 # 6308 <ustack_free+0x152>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	d1a50513          	addi	a0,a0,-742 # 6478 <ustack_free+0x2c2>
     ...
     780:	d1450513          	addi	a0,a0,-748 # 6490 <ustack_free+0x2da>
     ...
     79a:	c9a50513          	addi	a0,a0,-870 # 6430 <ustack_free+0x27a>
     ...
     7b4:	d1050513          	addi	a0,a0,-752 # 64c0 <ustack_free+0x30a>
     ...
     7d2:	d0a50513          	addi	a0,a0,-758 # 64d8 <ustack_free+0x322>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	adc58593          	addi	a1,a1,-1316 # 6300 <ustack_free+0x14a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	ab050513          	addi	a0,a0,-1360 # 62f0 <ustack_free+0x13a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	a8450513          	addi	a0,a0,-1404 # 62f0 <ustack_free+0x13a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	a7050513          	addi	a0,a0,-1424 # 62f0 <ustack_free+0x13a>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	caa58593          	addi	a1,a1,-854 # 6568 <ustack_free+0x3b2>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	9f050513          	addi	a0,a0,-1552 # 62f0 <ustack_free+0x13a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	bc450513          	addi	a0,a0,-1084 # 6508 <ustack_free+0x352>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	bc850513          	addi	a0,a0,-1080 # 6528 <ustack_free+0x372>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	bc450513          	addi	a0,a0,-1084 # 6538 <ustack_free+0x382>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	bc850513          	addi	a0,a0,-1080 # 6558 <ustack_free+0x3a2>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	b9450513          	addi	a0,a0,-1132 # 6538 <ustack_free+0x382>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	bae50513          	addi	a0,a0,-1106 # 6570 <ustack_free+0x3ba>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	bb050513          	addi	a0,a0,-1104 # 6590 <ustack_free+0x3da>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	b9c50513          	addi	a0,a0,-1124 # 65b0 <ustack_free+0x3fa>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	bac98993          	addi	s3,s3,-1108 # 65d8 <ustack_free+0x422>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	bdca8a93          	addi	s5,s5,-1060 # 6610 <ustack_free+0x45a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	b3650513          	addi	a0,a0,-1226 # 65b0 <ustack_free+0x3fa>
  ...
  if(unlink("small") < 0){
     ...
     aba:	afa50513          	addi	a0,a0,-1286 # 65b0 <ustack_free+0x3fa>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	ad850513          	addi	a0,a0,-1320 # 65b8 <ustack_free+0x402>
    ...
    exit(1);
     ...
     b02:	aea50513          	addi	a0,a0,-1302 # 65e8 <ustack_free+0x432>
     ...
     b20:	b0450513          	addi	a0,a0,-1276 # 6620 <ustack_free+0x46a>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	b1050513          	addi	a0,a0,-1264 # 6648 <ustack_free+0x492>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	b1450513          	addi	a0,a0,-1260 # 6668 <ustack_free+0x4b2>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	b1050513          	addi	a0,a0,-1264 # 6680 <ustack_free+0x4ca>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	afe50513          	addi	a0,a0,-1282 # 66a0 <ustack_free+0x4ea>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	aac50513          	addi	a0,a0,-1364 # 66a0 <ustack_free+0x4ea>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	a6c50513          	addi	a0,a0,-1428 # 66a8 <ustack_free+0x4f2>
    ...
    exit(1);
     ...
     c5e:	a6e50513          	addi	a0,a0,-1426 # 66c8 <ustack_free+0x512>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	a7a50513          	addi	a0,a0,-1414 # 66f0 <ustack_free+0x53a>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	9fe50513          	addi	a0,a0,-1538 # 66a0 <ustack_free+0x4ea>
     ...
     cd2:	a4250513          	addi	a0,a0,-1470 # 6710 <ustack_free+0x55a>
     ...
     cf0:	a4c50513          	addi	a0,a0,-1460 # 6738 <ustack_free+0x582>
     ...
     d0e:	a4650513          	addi	a0,a0,-1466 # 6750 <ustack_free+0x59a>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	a5250513          	addi	a0,a0,-1454 # 6778 <ustack_free+0x5c2>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	a3c50513          	addi	a0,a0,-1476 # 6790 <ustack_free+0x5da>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	a5458593          	addi	a1,a1,-1452 # 67c0 <ustack_free+0x60a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	a0850513          	addi	a0,a0,-1528 # 6790 <ustack_free+0x5da>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	9f250513          	addi	a0,a0,-1550 # 6790 <ustack_free+0x5da>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	9dc50513          	addi	a0,a0,-1572 # 6790 <ustack_free+0x5da>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	a4058593          	addi	a1,a1,-1472 # 6808 <ustack_free+0x652>
  ...
  unlink("unlinkread");
     ...
     e34:	96050513          	addi	a0,a0,-1696 # 6790 <ustack_free+0x5da>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	95050513          	addi	a0,a0,-1712 # 67a0 <ustack_free+0x5ea>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	95c50513          	addi	a0,a0,-1700 # 67c8 <ustack_free+0x612>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	96050513          	addi	a0,a0,-1696 # 67e8 <ustack_free+0x632>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	96c50513          	addi	a0,a0,-1684 # 6810 <ustack_free+0x65a>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	97050513          	addi	a0,a0,-1680 # 6830 <ustack_free+0x67a>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	97450513          	addi	a0,a0,-1676 # 6850 <ustack_free+0x69a>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	88058593          	addi	a1,a1,-1920 # 67c0 <ustack_free+0x60a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	91858593          	addi	a1,a1,-1768 # 6878 <ustack_free+0x6c2>
     f68:	00006517          	auipc	a0,0x6
     f6c:	90850513          	addi	a0,a0,-1784 # 6870 <ustack_free+0x6ba>
  ...
  unlink("lf1");
     ...
     f80:	8f450513          	addi	a0,a0,-1804 # 6870 <ustack_free+0x6ba>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00006517          	auipc	a0,0x6
     f92:	8e250513          	addi	a0,a0,-1822 # 6870 <ustack_free+0x6ba>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	8d450513          	addi	a0,a0,-1836 # 6878 <ustack_free+0x6c2>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	89c58593          	addi	a1,a1,-1892 # 6878 <ustack_free+0x6c2>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	88650513          	addi	a0,a0,-1914 # 6878 <ustack_free+0x6c2>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00006597          	auipc	a1,0x6
    1006:	86e58593          	addi	a1,a1,-1938 # 6870 <ustack_free+0x6ba>
    100a:	00006517          	auipc	a0,0x6
    100e:	86e50513          	addi	a0,a0,-1938 # 6878 <ustack_free+0x6c2>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	85258593          	addi	a1,a1,-1966 # 6870 <ustack_free+0x6ba>
    1026:	00006517          	auipc	a0,0x6
    102a:	95a50513          	addi	a0,a0,-1702 # 6980 <ustack_free+0x7ca>
    ...
    104c:	83850513          	addi	a0,a0,-1992 # 6880 <ustack_free+0x6ca>
    ...
    1068:	83450513          	addi	a0,a0,-1996 # 6898 <ustack_free+0x6e2>
    ...
    1084:	83050513          	addi	a0,a0,-2000 # 68b0 <ustack_free+0x6fa>
    ...
    10a0:	83450513          	addi	a0,a0,-1996 # 68d0 <ustack_free+0x71a>
    ...
    10bc:	84850513          	addi	a0,a0,-1976 # 6900 <ustack_free+0x74a>
    ...
    10d8:	84450513          	addi	a0,a0,-1980 # 6918 <ustack_free+0x762>
    ...
    10f4:	84050513          	addi	a0,a0,-1984 # 6930 <ustack_free+0x77a>
    ...
    1110:	84c50513          	addi	a0,a0,-1972 # 6958 <ustack_free+0x7a2>
    ...
    112c:	86050513          	addi	a0,a0,-1952 # 6988 <ustack_free+0x7d2>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	84e98993          	addi	s3,s3,-1970 # 69a8 <ustack_free+0x7f2>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	82250513          	addi	a0,a0,-2014 # 69b8 <ustack_free+0x802>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	7dca0a13          	addi	s4,s4,2012 # 69d8 <ustack_free+0x822>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	78a50513          	addi	a0,a0,1930 # 69d8 <ustack_free+0x822>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	72250513          	addi	a0,a0,1826 # 69e0 <ustack_free+0x82a>
    ...
    12e2:	72250513          	addi	a0,a0,1826 # 6a00 <ustack_free+0x84a>
    ...
    12fe:	72650513          	addi	a0,a0,1830 # 6a20 <ustack_free+0x86a>
...
000000000000134c <badarg>:
{
    ...
    136a:	f3298993          	addi	s3,s3,-206 # 6298 <ustack_free+0xe2>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	88878793          	addi	a5,a5,-1912 # 7c78 <ustack_free+0x1ac2>
  ...
  if(pid == 0){
    ...
    1450:	24c78793          	addi	a5,a5,588 # 8698 <ustack_free+0x24e2>
    ...
    1474:	e2850513          	addi	a0,a0,-472 # 6298 <ustack_free+0xe2>
    ...
    148c:	64050513          	addi	a0,a0,1600 # 6ac8 <ustack_free+0x912>
    ...
    14ac:	59850513          	addi	a0,a0,1432 # 6a40 <ustack_free+0x88a>
    ...
    14cc:	59850513          	addi	a0,a0,1432 # 6a60 <ustack_free+0x8aa>
    ...
    14ee:	59650513          	addi	a0,a0,1430 # 6a80 <ustack_free+0x8ca>
    ...
    150e:	59e50513          	addi	a0,a0,1438 # 6aa8 <ustack_free+0x8f2>
    ...
    1528:	a0450513          	addi	a0,a0,-1532 # 6f28 <ustack_free+0xd72>
  ...
  if(st != 747){
    ...
    1572:	58250513          	addi	a0,a0,1410 # 6af0 <ustack_free+0x93a>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	d5050513          	addi	a0,a0,-688 # 62f0 <ustack_free+0x13a>
  ...
  if(pid == 0){
    ...
    15ce:	d26a0a13          	addi	s4,s4,-730 # 62f0 <ustack_free+0x13a>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	57ea8a93          	addi	s5,s5,1406 # 6b50 <ustack_free+0x99a>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	4de50513          	addi	a0,a0,1246 # 6b20 <ustack_free+0x96a>
    ...
    1662:	4da50513          	addi	a0,a0,1242 # 6b38 <ustack_free+0x982>
    ...
    1680:	4e450513          	addi	a0,a0,1252 # 6b60 <ustack_free+0x9aa>
    ...
    169e:	c56a0a13          	addi	s4,s4,-938 # 62f0 <ustack_free+0x13a>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	4dea8a93          	addi	s5,s5,1246 # 6b80 <ustack_free+0x9ca>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	c0450513          	addi	a0,a0,-1020 # 62f0 <ustack_free+0x13a>
  ...
  exit(xstatus);
    ...
    170e:	42e50513          	addi	a0,a0,1070 # 6b38 <ustack_free+0x982>
    ...
    172c:	46050513          	addi	a0,a0,1120 # 6b88 <ustack_free+0x9d2>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	b4878793          	addi	a5,a5,-1208 # 6298 <ustack_free+0xe2>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	44c78793          	addi	a5,a5,1100 # 6ba8 <ustack_free+0x9f2>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	44450513          	addi	a0,a0,1092 # 6bb0 <ustack_free+0x9fa>
  ...
  if(pid == 0) {
    ...
    179e:	41650513          	addi	a0,a0,1046 # 6bb0 <ustack_free+0x9fa>
    ...
    17ba:	41a50513          	addi	a0,a0,1050 # 6bd0 <ustack_free+0xa1a>
    ...
    17d6:	34e50513          	addi	a0,a0,846 # 6b20 <ustack_free+0x96a>
    ...
    17f2:	3ca50513          	addi	a0,a0,970 # 6bb8 <ustack_free+0xa02>
    ...
    1810:	a8c50513          	addi	a0,a0,-1396 # 6298 <ustack_free+0xe2>
  ...
  if(xstatus != 0)
    ...
    1844:	3a050513          	addi	a0,a0,928 # 6be0 <ustack_free+0xa2a>
    ...
    1860:	39c50513          	addi	a0,a0,924 # 6bf8 <ustack_free+0xa42>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	34050513          	addi	a0,a0,832 # 6bb0 <ustack_free+0x9fa>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	dce50513          	addi	a0,a0,-562 # 6668 <ustack_free+0x4b2>
    ...
    18ba:	28250513          	addi	a0,a0,642 # 6b38 <ustack_free+0x982>
  ...
  unlink("echo-ok");
    ...
    18d4:	2e050513          	addi	a0,a0,736 # 6bb0 <ustack_free+0x9fa>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	31650513          	addi	a0,a0,790 # 6c10 <ustack_free+0xa5a>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	26c50513          	addi	a0,a0,620 # 6c28 <ustack_free+0xa72>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	1fe50513          	addi	a0,a0,510 # 6c40 <ustack_free+0xa8a>
    ...
    1a62:	1fa50513          	addi	a0,a0,506 # 6c58 <ustack_free+0xaa2>
    ...
    1a94:	1e050513          	addi	a0,a0,480 # 6c70 <ustack_free+0xaba>
    ...
    1ad4:	1c050513          	addi	a0,a0,448 # 6c90 <ustack_free+0xada>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	fde50513          	addi	a0,a0,-34 # 6b20 <ustack_free+0x96a>
    ...
    1b62:	14a50513          	addi	a0,a0,330 # 6ca8 <ustack_free+0xaf2>
    ...
    1b7e:	14650513          	addi	a0,a0,326 # 6cc0 <ustack_free+0xb0a>
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	f2e50513          	addi	a0,a0,-210 # 6b20 <ustack_free+0x96a>
    ...
    1c1a:	f0a50513          	addi	a0,a0,-246 # 6b20 <ustack_free+0x96a>
...
0000000000001c38 <forkfork>:
{
    ...
    1c94:	05050513          	addi	a0,a0,80 # 6ce0 <ustack_free+0xb2a>
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	00850513          	addi	a0,a0,8 # 6cf0 <ustack_free+0xb3a>
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	1f250513          	addi	a0,a0,498 # 6f28 <ustack_free+0xd72>
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	15450513          	addi	a0,a0,340 # 6f28 <ustack_free+0xd72>
    ...
    1e04:	db850513          	addi	a0,a0,-584 # 6bb8 <ustack_free+0xa02>
    ...
    1e76:	e9e50513          	addi	a0,a0,-354 # 6d10 <ustack_free+0xb5a>
    ...
    1eaa:	e8250513          	addi	a0,a0,-382 # 6d28 <ustack_free+0xb72>
    ...
    1f10:	e4450513          	addi	a0,a0,-444 # 6d50 <ustack_free+0xb9a>
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	35c50513          	addi	a0,a0,860 # 6308 <ustack_free+0x152>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	320a8a93          	addi	s5,s5,800 # 6308 <ustack_free+0x152>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	d88b8b93          	addi	s7,s7,-632 # 6d78 <ustack_free+0xbc2>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	b2450513          	addi	a0,a0,-1244 # 6b20 <ustack_free+0x96a>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	cda50513          	addi	a0,a0,-806 # 6d98 <ustack_free+0xbe2>
  ...
  if(wait(0) != -1){
    ...
    2124:	c6050513          	addi	a0,a0,-928 # 6d80 <ustack_free+0xbca>
    ...
    2140:	c8450513          	addi	a0,a0,-892 # 6dc0 <ustack_free+0xc0a>
    ...
    215c:	c8050513          	addi	a0,a0,-896 # 6dd8 <ustack_free+0xc22>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	94850513          	addi	a0,a0,-1720 # 6b20 <ustack_free+0x96a>
    ...
    21fe:	bf650513          	addi	a0,a0,-1034 # 6df0 <ustack_free+0xc3a>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	8a450513          	addi	a0,a0,-1884 # 6b20 <ustack_free+0x96a>
    ...
    22ac:	b6850513          	addi	a0,a0,-1176 # 6e10 <ustack_free+0xc5a>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	b5050513          	addi	a0,a0,-1200 # 6e28 <ustack_free+0xc72>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	b1e50513          	addi	a0,a0,-1250 # 6e28 <ustack_free+0xc72>
  ...
  close(fd);
    ...
    2344:	af870713          	addi	a4,a4,-1288 # 6e38 <ustack_free+0xc82>
    ...
    2398:	b8450513          	addi	a0,a0,-1148 # 6f18 <ustack_free+0xd62>
    ...
    23bc:	b8050513          	addi	a0,a0,-1152 # 6f38 <ustack_free+0xd82>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    241a:	b4250513          	addi	a0,a0,-1214 # 6f58 <ustack_free+0xda2>
    ...
    2436:	6ee50513          	addi	a0,a0,1774 # 6b20 <ustack_free+0x96a>
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	68050513          	addi	a0,a0,1664 # 6b20 <ustack_free+0x96a>
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	a0c50513          	addi	a0,a0,-1524 # 6f28 <ustack_free+0xd72>
    ...
    25d0:	9b450513          	addi	a0,a0,-1612 # 6f80 <ustack_free+0xdca>
    ...
    25f0:	d7c50513          	addi	a0,a0,-644 # 6368 <ustack_free+0x1b2>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	5f478793          	addi	a5,a5,1524 # 7c78 <ustack_free+0x1ac2>
  ...
  if(ret != -1){
    ...
    26ca:	8d250513          	addi	a0,a0,-1838 # 6f98 <ustack_free+0xde2>
    ...
    26e8:	35c50513          	addi	a0,a0,860 # 6a40 <ustack_free+0x88a>
    ...
    2706:	35e50513          	addi	a0,a0,862 # 6a60 <ustack_free+0x8aa>
    ...
    2726:	35e50513          	addi	a0,a0,862 # 6a80 <ustack_free+0x8ca>
    ...
    2744:	36850513          	addi	a0,a0,872 # 6aa8 <ustack_free+0x8f2>
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	84c50513          	addi	a0,a0,-1972 # 6fd8 <ustack_free+0xe22>
  ...
  if(n >= 0){
    ...
    27c2:	83a50513          	addi	a0,a0,-1990 # 6ff8 <ustack_free+0xe42>
    ...
    27dc:	7c850513          	addi	a0,a0,1992 # 6fa0 <ustack_free+0xdea>
    ...
    27f6:	7c650513          	addi	a0,a0,1990 # 6fb8 <ustack_free+0xe02>
    ...
    2810:	7d450513          	addi	a0,a0,2004 # 6fe0 <ustack_free+0xe2a>
  ...
  unlink("rwsbrk");
    ...
    2834:	7a850513          	addi	a0,a0,1960 # 6fd8 <ustack_free+0xe22>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	c2e50513          	addi	a0,a0,-978 # 6470 <ustack_free+0x2ba>
  ...
  if(n >= 0){
    ...
    2870:	7bc50513          	addi	a0,a0,1980 # 7028 <ustack_free+0xe72>
    ...
    288a:	75a50513          	addi	a0,a0,1882 # 6fe0 <ustack_free+0xe2a>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    290a:	74a50513          	addi	a0,a0,1866 # 7050 <ustack_free+0xe9a>
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	71850513          	addi	a0,a0,1816 # 7070 <ustack_free+0xeba>
  ...
  if(c != a + 1){
    ...
    29c0:	71450513          	addi	a0,a0,1812 # 70d0 <ustack_free+0xf1a>
    ...
    29e2:	6b250513          	addi	a0,a0,1714 # 7090 <ustack_free+0xeda>
    ...
    29fe:	6b650513          	addi	a0,a0,1718 # 70b0 <ustack_free+0xefa>
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b48:	5ac50513          	addi	a0,a0,1452 # 70f0 <ustack_free+0xf3a>
    ...
    2b64:	5d850513          	addi	a0,a0,1496 # 7138 <ustack_free+0xf82>
    ...
    2b84:	5d850513          	addi	a0,a0,1496 # 7158 <ustack_free+0xfa2>
    ...
    2ba4:	5f850513          	addi	a0,a0,1528 # 7198 <ustack_free+0xfe2>
    ...
    2bc0:	60c50513          	addi	a0,a0,1548 # 71c8 <ustack_free+0x1012>
    ...
    2be0:	62450513          	addi	a0,a0,1572 # 7200 <ustack_free+0x104a>
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	61250513          	addi	a0,a0,1554 # 7228 <ustack_free+0x1072>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	60050513          	addi	a0,a0,1536 # 7228 <ustack_free+0x1072>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	5b450513          	addi	a0,a0,1460 # 7230 <ustack_free+0x107a>
    ...
    2c9c:	5b050513          	addi	a0,a0,1456 # 7248 <ustack_free+0x1092>
    ...
    2cb8:	f7450513          	addi	a0,a0,-140 # 6c28 <ustack_free+0xa72>
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	58250513          	addi	a0,a0,1410 # 7260 <ustack_free+0x10aa>
  ...
  close(fd);
    ...
    2d2a:	e1250513          	addi	a0,a0,-494 # 6b38 <ustack_free+0x982>
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	1b450513          	addi	a0,a0,436 # 6f28 <ustack_free+0xd72>
  ...
  if(pid == 0){
    ...
    2dce:	15e50513          	addi	a0,a0,350 # 6f28 <ustack_free+0xd72>
  ...
  if(pid == 0){
    ...
    2e2e:	0fe50513          	addi	a0,a0,254 # 6f28 <ustack_free+0xd72>
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	f8a50513          	addi	a0,a0,-118 # 6f28 <ustack_free+0xd72>
    ...
    2ff6:	2a650513          	addi	a0,a0,678 # 6298 <ustack_free+0xe2>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	30a78793          	addi	a5,a5,778 # 6308 <ustack_free+0x152>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	40850513          	addi	a0,a0,1032 # 7438 <ustack_free+0x1282>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	24e50513          	addi	a0,a0,590 # 7290 <ustack_free+0x10da>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	29050513          	addi	a0,a0,656 # 72e8 <ustack_free+0x1132>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	2ea50513          	addi	a0,a0,746 # 7360 <ustack_free+0x11aa>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	33e50513          	addi	a0,a0,830 # 73d0 <ustack_free+0x121a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	38450513          	addi	a0,a0,900 # 7428 <ustack_free+0x1272>
  ...
  unlink("12345678901234");
    ...
    3126:	14650513          	addi	a0,a0,326 # 7268 <ustack_free+0x10b2>
    ...
    3142:	17250513          	addi	a0,a0,370 # 72b0 <ustack_free+0x10fa>
    ...
    315e:	1be50513          	addi	a0,a0,446 # 7318 <ustack_free+0x1162>
    ...
    317a:	21a50513          	addi	a0,a0,538 # 7390 <ustack_free+0x11da>
    ...
    3196:	25e50513          	addi	a0,a0,606 # 73f0 <ustack_free+0x123a>
    ...
    31b2:	29a50513          	addi	a0,a0,666 # 7448 <ustack_free+0x1292>
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	28650513          	addi	a0,a0,646 # 7480 <ustack_free+0x12ca>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	26c50513          	addi	a0,a0,620 # 7490 <ustack_free+0x12da>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	1cc50513          	addi	a0,a0,460 # 7480 <ustack_free+0x12ca>
  ...
  unlink("diskfulldir");
    ...
    32cc:	1b850513          	addi	a0,a0,440 # 7480 <ustack_free+0x12ca>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	0ba50513          	addi	a0,a0,186 # 74b0 <ustack_free+0x12fa>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	0cc50513          	addi	a0,a0,204 # 74e0 <ustack_free+0x132a>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	0b850513          	addi	a0,a0,184 # 74e0 <ustack_free+0x132a>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	0e450513          	addi	a0,a0,228 # 7520 <ustack_free+0x136a>
  ...
  if(chdir("/") < 0){
    ...
    3454:	10050513          	addi	a0,a0,256 # 7550 <ustack_free+0x139a>
    ...
    3474:	07850513          	addi	a0,a0,120 # 74e8 <ustack_free+0x1332>
    ...
    3490:	07450513          	addi	a0,a0,116 # 7500 <ustack_free+0x134a>
    ...
    34ac:	08850513          	addi	a0,a0,136 # 7530 <ustack_free+0x137a>
    ...
    34c8:	09450513          	addi	a0,a0,148 # 7558 <ustack_free+0x13a2>
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	fe850513          	addi	a0,a0,-24 # 74e0 <ustack_free+0x132a>
    ...
    3510:	fd450513          	addi	a0,a0,-44 # 74e0 <ustack_free+0x132a>
    ...
    3544:	5e050513          	addi	a0,a0,1504 # 6b20 <ustack_free+0x96a>
    ...
    3560:	f8c50513          	addi	a0,a0,-116 # 74e8 <ustack_free+0x1332>
    ...
    357c:	ff850513          	addi	a0,a0,-8 # 7570 <ustack_free+0x13ba>
    ...
    3598:	f9c50513          	addi	a0,a0,-100 # 7530 <ustack_free+0x137a>
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	fb650513          	addi	a0,a0,-74 # 7588 <ustack_free+0x13d2>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	fa250513          	addi	a0,a0,-94 # 7588 <ustack_free+0x13d2>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	fae50513          	addi	a0,a0,-82 # 75a8 <ustack_free+0x13f2>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	f7a50513          	addi	a0,a0,-134 # 7588 <ustack_free+0x13d2>
    ...
    3632:	eba50513          	addi	a0,a0,-326 # 74e8 <ustack_free+0x1332>
    ...
    364e:	f4650513          	addi	a0,a0,-186 # 7590 <ustack_free+0x13da>
    ...
    366a:	f4a50513          	addi	a0,a0,-182 # 75b0 <ustack_free+0x13fa>
    ...
    3686:	f4650513          	addi	a0,a0,-186 # 75c8 <ustack_free+0x1412>
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	06650513          	addi	a0,a0,102 # 7710 <ustack_free+0x155a>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	f2650513          	addi	a0,a0,-218 # 75e0 <ustack_free+0x142a>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	f2e50513          	addi	a0,a0,-210 # 7600 <ustack_free+0x144a>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	02658593          	addi	a1,a1,38 # 7710 <ustack_free+0x155a>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	edc50513          	addi	a0,a0,-292 # 75e0 <ustack_free+0x142a>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	f4050513          	addi	a0,a0,-192 # 7658 <ustack_free+0x14a2>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	f5050513          	addi	a0,a0,-176 # 7680 <ustack_free+0x14ca>
  ...
  write(fd, "FF", 2);
    ...
    374c:	f6858593          	addi	a1,a1,-152 # 76b0 <ustack_free+0x14fa>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	f5450513          	addi	a0,a0,-172 # 76b8 <ustack_free+0x1502>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	f5c58593          	addi	a1,a1,-164 # 7708 <ustack_free+0x1552>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	ecc50513          	addi	a0,a0,-308 # 7680 <ustack_free+0x14ca>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	eb850513          	addi	a0,a0,-328 # 7680 <ustack_free+0x14ca>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	ea250513          	addi	a0,a0,-350 # 7680 <ustack_free+0x14ca>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	dee50513          	addi	a0,a0,-530 # 75e0 <ustack_free+0x142a>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	f9a50513          	addi	a0,a0,-102 # 77a0 <ustack_free+0x15ea>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	fb650513          	addi	a0,a0,-74 # 77d0 <ustack_free+0x161a>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	fd250513          	addi	a0,a0,-46 # 7800 <ustack_free+0x164a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	ec450513          	addi	a0,a0,-316 # 7708 <ustack_free+0x1552>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	e0250513          	addi	a0,a0,-510 # 7680 <ustack_free+0x14ca>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	ffa50513          	addi	a0,a0,-6 # 7890 <ustack_free+0x16da>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	01250513          	addi	a0,a0,18 # 78c0 <ustack_free+0x170a>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	d1a50513          	addi	a0,a0,-742 # 75e0 <ustack_free+0x142a>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	d0450513          	addi	a0,a0,-764 # 75e0 <ustack_free+0x142a>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	cee50513          	addi	a0,a0,-786 # 75e0 <ustack_free+0x142a>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	04a58593          	addi	a1,a1,74 # 7950 <ustack_free+0x179a>
    390e:	00004517          	auipc	a0,0x4
    3912:	f8250513          	addi	a0,a0,-126 # 7890 <ustack_free+0x16da>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	02e58593          	addi	a1,a1,46 # 7950 <ustack_free+0x179a>
    392a:	00004517          	auipc	a0,0x4
    392e:	f9650513          	addi	a0,a0,-106 # 78c0 <ustack_free+0x170a>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	dca58593          	addi	a1,a1,-566 # 7708 <ustack_free+0x1552>
    3946:	00004517          	auipc	a0,0x4
    394a:	cba50513          	addi	a0,a0,-838 # 7600 <ustack_free+0x144a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	f3650513          	addi	a0,a0,-202 # 7890 <ustack_free+0x16da>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	f5250513          	addi	a0,a0,-174 # 78c0 <ustack_free+0x170a>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	d8650513          	addi	a0,a0,-634 # 7708 <ustack_free+0x1552>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	f2a50513          	addi	a0,a0,-214 # 78c0 <ustack_free+0x170a>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	ee650513          	addi	a0,a0,-282 # 7890 <ustack_free+0x16da>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	c4250513          	addi	a0,a0,-958 # 7600 <ustack_free+0x144a>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	0ce50513          	addi	a0,a0,206 # 7aa0 <ustack_free+0x18ea>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	d2250513          	addi	a0,a0,-734 # 7708 <ustack_free+0x1552>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	c0650513          	addi	a0,a0,-1018 # 7600 <ustack_free+0x144a>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	bd250513          	addi	a0,a0,-1070 # 75e0 <ustack_free+0x142a>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	0ee50513          	addi	a0,a0,238 # 7b10 <ustack_free+0x195a>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	baa50513          	addi	a0,a0,-1110 # 75e0 <ustack_free+0x142a>
    ...
    3a5c:	b9050513          	addi	a0,a0,-1136 # 75e8 <ustack_free+0x1432>
    ...
    3a78:	b9450513          	addi	a0,a0,-1132 # 7608 <ustack_free+0x1452>
    ...
    3a94:	b9850513          	addi	a0,a0,-1128 # 7628 <ustack_free+0x1472>
    ...
    3ab0:	bb450513          	addi	a0,a0,-1100 # 7660 <ustack_free+0x14aa>
    ...
    3acc:	bc850513          	addi	a0,a0,-1080 # 7690 <ustack_free+0x14da>
    ...
    3ae8:	be450513          	addi	a0,a0,-1052 # 76c8 <ustack_free+0x1512>
    ...
    3b04:	be850513          	addi	a0,a0,-1048 # 76e8 <ustack_free+0x1532>
    ...
    3b20:	bfc50513          	addi	a0,a0,-1028 # 7718 <ustack_free+0x1562>
    ...
    3b3c:	c0850513          	addi	a0,a0,-1016 # 7740 <ustack_free+0x158a>
    ...
    3b58:	c0c50513          	addi	a0,a0,-1012 # 7760 <ustack_free+0x15aa>
    ...
    3b74:	c1850513          	addi	a0,a0,-1000 # 7788 <ustack_free+0x15d2>
    ...
    3b90:	c2450513          	addi	a0,a0,-988 # 77b0 <ustack_free+0x15fa>
    ...
    3bac:	c3850513          	addi	a0,a0,-968 # 77e0 <ustack_free+0x162a>
    ...
    3bc8:	c4450513          	addi	a0,a0,-956 # 7808 <ustack_free+0x1652>
    ...
    3be4:	c4050513          	addi	a0,a0,-960 # 7820 <ustack_free+0x166a>
    ...
    3c00:	c4450513          	addi	a0,a0,-956 # 7840 <ustack_free+0x168a>
    ...
    3c1c:	c4850513          	addi	a0,a0,-952 # 7860 <ustack_free+0x16aa>
    ...
    3c38:	c6c50513          	addi	a0,a0,-916 # 78a0 <ustack_free+0x16ea>
    ...
    3c54:	c8050513          	addi	a0,a0,-896 # 78d0 <ustack_free+0x171a>
    ...
    3c70:	c8450513          	addi	a0,a0,-892 # 78f0 <ustack_free+0x173a>
    ...
    3c8c:	c8850513          	addi	a0,a0,-888 # 7910 <ustack_free+0x175a>
    ...
    3ca8:	c8c50513          	addi	a0,a0,-884 # 7930 <ustack_free+0x177a>
    ...
    3cc4:	ca050513          	addi	a0,a0,-864 # 7960 <ustack_free+0x17aa>
    ...
    3ce0:	cac50513          	addi	a0,a0,-852 # 7988 <ustack_free+0x17d2>
    ...
    3cfc:	cb850513          	addi	a0,a0,-840 # 79b0 <ustack_free+0x17fa>
    ...
    3d18:	cc450513          	addi	a0,a0,-828 # 79d8 <ustack_free+0x1822>
    ...
    3d34:	cc850513          	addi	a0,a0,-824 # 79f8 <ustack_free+0x1842>
    ...
    3d50:	ccc50513          	addi	a0,a0,-820 # 7a18 <ustack_free+0x1862>
    ...
    3d6c:	cd850513          	addi	a0,a0,-808 # 7a40 <ustack_free+0x188a>
    ...
    3d88:	cdc50513          	addi	a0,a0,-804 # 7a60 <ustack_free+0x18aa>
    ...
    3da4:	ce050513          	addi	a0,a0,-800 # 7a80 <ustack_free+0x18ca>
    ...
    3dc0:	cec50513          	addi	a0,a0,-788 # 7aa8 <ustack_free+0x18f2>
    ...
    3ddc:	96850513          	addi	a0,a0,-1688 # 7740 <ustack_free+0x158a>
    ...
    3df8:	cd450513          	addi	a0,a0,-812 # 7ac8 <ustack_free+0x1912>
    ...
    3e14:	cd850513          	addi	a0,a0,-808 # 7ae8 <ustack_free+0x1932>
    ...
    3e30:	cec50513          	addi	a0,a0,-788 # 7b18 <ustack_free+0x1962>
    ...
    3e4c:	cf050513          	addi	a0,a0,-784 # 7b38 <ustack_free+0x1982>
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	ce250513          	addi	a0,a0,-798 # 7b50 <ustack_free+0x199a>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	cd050513          	addi	a0,a0,-816 # 7b50 <ustack_free+0x199a>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	aee50513          	addi	a0,a0,-1298 # 6980 <ustack_free+0x7ca>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	70450513          	addi	a0,a0,1796 # 75a8 <ustack_free+0x13f2>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	69a50513          	addi	a0,a0,1690 # 7550 <ustack_free+0x139a>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	cf050513          	addi	a0,a0,-784 # 7bb8 <ustack_free+0x1a02>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	d0650513          	addi	a0,a0,-762 # 7be0 <ustack_free+0x1a2a>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	c6450513          	addi	a0,a0,-924 # 7b50 <ustack_free+0x199a>
    ...
    3f0e:	c4e50513          	addi	a0,a0,-946 # 7b58 <ustack_free+0x19a2>
    ...
    3f2a:	c4a50513          	addi	a0,a0,-950 # 7b70 <ustack_free+0x19ba>
    ...
    3f46:	c4650513          	addi	a0,a0,-954 # 7b88 <ustack_free+0x19d2>
    ...
    3f62:	c4250513          	addi	a0,a0,-958 # 7ba0 <ustack_free+0x19ea>
    ...
    3f7e:	5de50513          	addi	a0,a0,1502 # 7558 <ustack_free+0x13a2>
    ...
    3f9a:	c2a50513          	addi	a0,a0,-982 # 7bc0 <ustack_free+0x1a0a>
    ...
    3fb6:	c3650513          	addi	a0,a0,-970 # 7be8 <ustack_free+0x1a32>
    ...
    3fd2:	c3a50513          	addi	a0,a0,-966 # 7c08 <ustack_free+0x1a52>
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	c2e50513          	addi	a0,a0,-978 # 7c28 <ustack_free+0x1a72>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	c1250513          	addi	a0,a0,-1006 # 7c28 <ustack_free+0x1a72>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	c4650513          	addi	a0,a0,-954 # 7c70 <ustack_free+0x1aba>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	c2e50513          	addi	a0,a0,-978 # 7c70 <ustack_free+0x1aba>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	c1a50513          	addi	a0,a0,-998 # 7c70 <ustack_free+0x1aba>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	c0650513          	addi	a0,a0,-1018 # 7c70 <ustack_free+0x1aba>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	bf258593          	addi	a1,a1,-1038 # 7c70 <ustack_free+0x1aba>
    4086:	00002517          	auipc	a0,0x2
    408a:	3ea50513          	addi	a0,a0,1002 # 6470 <ustack_free+0x2ba>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	b8e50513          	addi	a0,a0,-1138 # 7c28 <ustack_free+0x1a72>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	8d050513          	addi	a0,a0,-1840 # 6980 <ustack_free+0x7ca>
  ...
  fd = open(".", 0);
    ...
    40ca:	8ba50513          	addi	a0,a0,-1862 # 6980 <ustack_free+0x7ca>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	22e58593          	addi	a1,a1,558 # 6308 <ustack_free+0x152>
  ...
  close(fd);
    ...
    410a:	b2a50513          	addi	a0,a0,-1238 # 7c30 <ustack_free+0x1a7a>
    ...
    4126:	b2e50513          	addi	a0,a0,-1234 # 7c50 <ustack_free+0x1a9a>
    ...
    4142:	b4250513          	addi	a0,a0,-1214 # 7c80 <ustack_free+0x1aca>
    ...
    415e:	b2650513          	addi	a0,a0,-1242 # 7c80 <ustack_free+0x1aca>
    ...
    417a:	b3250513          	addi	a0,a0,-1230 # 7ca8 <ustack_free+0x1af2>
    ...
    4196:	b3e50513          	addi	a0,a0,-1218 # 7cd0 <ustack_free+0x1b1a>
    ...
    41b2:	b4a50513          	addi	a0,a0,-1206 # 7cf8 <ustack_free+0x1b42>
    ...
    41ce:	b5650513          	addi	a0,a0,-1194 # 7d20 <ustack_free+0x1b6a>
    ...
    41ea:	b5a50513          	addi	a0,a0,-1190 # 7d40 <ustack_free+0x1b8a>
    ...
    4206:	b6650513          	addi	a0,a0,-1178 # 7d68 <ustack_free+0x1bb2>
...
000000000000421c <iref>:
{
    ...
    423a:	b4aa0a13          	addi	s4,s4,-1206 # 7d80 <ustack_free+0x1bca>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	64a48493          	addi	s1,s1,1610 # 7888 <ustack_free+0x16d2>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	22aa8a93          	addi	s5,s5,554 # 6470 <ustack_free+0x2ba>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	a2a98993          	addi	s3,s3,-1494 # 7c78 <ustack_free+0x1ac2>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	b2e50513          	addi	a0,a0,-1234 # 7d88 <ustack_free+0x1bd2>
    ...
    427a:	b2a50513          	addi	a0,a0,-1238 # 7da0 <ustack_free+0x1bea>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	29e98993          	addi	s3,s3,670 # 75a8 <ustack_free+0x13f2>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	a6e90913          	addi	s2,s2,-1426 # 7d80 <ustack_free+0x1bca>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	21e50513          	addi	a0,a0,542 # 7550 <ustack_free+0x139a>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	a5650513          	addi	a0,a0,-1450 # 7db8 <ustack_free+0x1c02>
  ...
  if(pid == 0){
    ...
    438a:	a3250513          	addi	a0,a0,-1486 # 7db8 <ustack_free+0x1c02>
    ...
    43a0:	a3c50513          	addi	a0,a0,-1476 # 7dd8 <ustack_free+0x1c22>
    ...
    43bc:	a0850513          	addi	a0,a0,-1528 # 7dc0 <ustack_free+0x1c0a>
    ...
    43d8:	74c50513          	addi	a0,a0,1868 # 6b20 <ustack_free+0x96a>
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	9b650513          	addi	a0,a0,-1610 # 7db8 <ustack_free+0x1c02>
    ...
    441a:	8fa50513          	addi	a0,a0,-1798 # 6d10 <ustack_free+0xb5a>
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	9ac50513          	addi	a0,a0,-1620 # 7e00 <ustack_free+0x1c4a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	98050513          	addi	a0,a0,-1664 # 7e00 <ustack_free+0x1c4a>
  ...
  sleep(10); // one second
    ...
    44bc:	82850513          	addi	a0,a0,-2008 # 6ce0 <ustack_free+0xb2a>
    ...
    44d6:	92e48493          	addi	s1,s1,-1746 # 7e00 <ustack_free+0x1c4a>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	5a650513          	addi	a0,a0,1446 # 6b20 <ustack_free+0x96a>
    ...
    45a4:	87050513          	addi	a0,a0,-1936 # 7e10 <ustack_free+0x1c5a>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	70050513          	addi	a0,a0,1792 # 6ce0 <ustack_free+0xb2a>
  ...
  if(pid2 == 0)
    ...
    4612:	51250513          	addi	a0,a0,1298 # 6b20 <ustack_free+0x96a>
  ...
  if(pid3 == 0){
    ...
    4656:	cb658593          	addi	a1,a1,-842 # 6308 <ustack_free+0x152>
    ...
    4680:	4a450513          	addi	a0,a0,1188 # 6b20 <ustack_free+0x96a>
    ...
    469c:	79850513          	addi	a0,a0,1944 # 7e30 <ustack_free+0x1c7a>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	77450513          	addi	a0,a0,1908 # 7e48 <ustack_free+0x1c92>
  ...
  printf("kill... ");
    ...
    4704:	76050513          	addi	a0,a0,1888 # 7e60 <ustack_free+0x1caa>
  ...
  printf("wait... ");
    ...
    4732:	74250513          	addi	a0,a0,1858 # 7e70 <ustack_free+0x1cba>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	37250513          	addi	a0,a0,882 # 6b20 <ustack_free+0x96a>
    ...
    47ce:	4de50513          	addi	a0,a0,1246 # 6ca8 <ustack_free+0xaf2>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	3e850513          	addi	a0,a0,1000 # 6c28 <ustack_free+0xa72>
    ...
    4878:	a9458593          	addi	a1,a1,-1388 # 6308 <ustack_free+0x152>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	54850513          	addi	a0,a0,1352 # 7e80 <ustack_free+0x1cca>
    ...
    4958:	1cc50513          	addi	a0,a0,460 # 6b20 <ustack_free+0x96a>
    ...
    49a4:	50050513          	addi	a0,a0,1280 # 7ea0 <ustack_free+0x1cea>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	48c50513          	addi	a0,a0,1164 # 7ed0 <ustack_free+0x1d1a>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	40650513          	addi	a0,a0,1030 # 7f00 <ustack_free+0x1d4a>
    ...
    4b1a:	41250513          	addi	a0,a0,1042 # 7f28 <ustack_free+0x1d72>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	39650513          	addi	a0,a0,918 # 7ef0 <ustack_free+0x1d3a>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	3ae50513          	addi	a0,a0,942 # 7f48 <ustack_free+0x1d92>
  ...
  unlink("sharedfd");
    ...
    4bda:	31a50513          	addi	a0,a0,794 # 7ef0 <ustack_free+0x1d3a>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	37450513          	addi	a0,a0,884 # 7f70 <ustack_free+0x1dba>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	5fe78793          	addi	a5,a5,1534 # 6240 <ustack_free+0x8a>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	5fa78793          	addi	a5,a5,1530 # 6248 <ustack_free+0x92>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	5f678793          	addi	a5,a5,1526 # 6250 <ustack_free+0x9a>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	5f278793          	addi	a5,a5,1522 # 6258 <ustack_free+0xa2>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	24a50513          	addi	a0,a0,586 # 6f28 <ustack_free+0xd72>
    ...
    4d5e:	22e50513          	addi	a0,a0,558 # 7f88 <ustack_free+0x1dd2>
    ...
    4d78:	22450513          	addi	a0,a0,548 # 7f98 <ustack_free+0x1de2>
    ...
    4da0:	21450513          	addi	a0,a0,532 # 7fb0 <ustack_free+0x1dfa>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	19650513          	addi	a0,a0,406 # 7fc0 <ustack_free+0x1e0a>
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	14cb8b93          	addi	s7,s7,332 # 7fd8 <ustack_free+0x1e22>
  for(i = 0; i < N; i++){
    ...
    4ed2:	11250513          	addi	a0,a0,274 # 7fe0 <ustack_free+0x1e2a>
    ...
    4ef0:	0ec50513          	addi	a0,a0,236 # 7fd8 <ustack_free+0x1e22>
  ...
  fd = open(".", 0);
    ...
    4f28:	a5c50513          	addi	a0,a0,-1444 # 6980 <ustack_free+0x7ca>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	06650513          	addi	a0,a0,102 # 8000 <ustack_free+0x1e4a>
    ...
    4fbe:	06650513          	addi	a0,a0,102 # 8020 <ustack_free+0x1e6a>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	05650513          	addi	a0,a0,86 # 8048 <ustack_free+0x1e92>
    ...
    5012:	b1250513          	addi	a0,a0,-1262 # 6b20 <ustack_free+0x96a>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	e4050513          	addi	a0,a0,-448 # 8080 <ustack_free+0x1eca>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	dec50513          	addi	a0,a0,-532 # 8090 <ustack_free+0x1eda>
    ...
    52c4:	df050513          	addi	a0,a0,-528 # 80b0 <ustack_free+0x1efa>
    ...
    52e0:	df450513          	addi	a0,a0,-524 # 80d0 <ustack_free+0x1f1a>
    ...
    52fc:	df850513          	addi	a0,a0,-520 # 80f0 <ustack_free+0x1f3a>
    ...
    5318:	dfc50513          	addi	a0,a0,-516 # 8110 <ustack_free+0x1f5a>
    ...
    5334:	df850513          	addi	a0,a0,-520 # 8128 <ustack_free+0x1f72>
  ...
  unlink("bigfile.dat");
    ...
    5362:	d2250513          	addi	a0,a0,-734 # 8080 <ustack_free+0x1eca>
    ...
    5386:	dc650513          	addi	a0,a0,-570 # 8148 <ustack_free+0x1f92>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	dae50513          	addi	a0,a0,-594 # 8168 <ustack_free+0x1fb2>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	d9ec8c93          	addi	s9,s9,-610 # 8178 <ustack_free+0x1fc2>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	d3450513          	addi	a0,a0,-716 # 8188 <ustack_free+0x1fd2>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	cde50513          	addi	a0,a0,-802 # 81a8 <ustack_free+0x1ff2>
    ...
    551e:	c7e50513          	addi	a0,a0,-898 # 8198 <ustack_free+0x1fe2>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	c7450513          	addi	a0,a0,-908 # 81c0 <ustack_free+0x200a>
  ...
  if(pid == 0) {
    ...
    5580:	c6c50513          	addi	a0,a0,-916 # 81e8 <ustack_free+0x2032>
    ...
    55a4:	c3050513          	addi	a0,a0,-976 # 81d0 <ustack_free+0x201a>
    ...
    55cc:	c2850513          	addi	a0,a0,-984 # 81f0 <ustack_free+0x203a>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	be050513          	addi	a0,a0,-1056 # 81f8 <ustack_free+0x2042>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	c9698993          	addi	s3,s3,-874 # 6308 <ustack_free+0x152>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	bac50513          	addi	a0,a0,-1108 # 8250 <ustack_free+0x209a>
    ...
    56c2:	b5250513          	addi	a0,a0,-1198 # 8210 <ustack_free+0x205a>
    ...
    56dc:	b5850513          	addi	a0,a0,-1192 # 8230 <ustack_free+0x207a>
  ...
  while(1){
    ...
    572a:	b4a50513          	addi	a0,a0,-1206 # 8270 <ustack_free+0x20ba>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	b08b8b93          	addi	s7,s7,-1272 # 8290 <ustack_free+0x20da>
    int free0 = countfree();
    int free1 = 0;
    ...
    579e:	b2ec8c93          	addi	s9,s9,-1234 # 82c8 <ustack_free+0x2112>
      if (runtests(slowtests, justone)) {
    57a2:	00004c17          	auipc	s8,0x4
    57a6:	c3ec0c13          	addi	s8,s8,-962 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57aa:	00003d17          	auipc	s10,0x3
    57ae:	afed0d13          	addi	s10,s10,-1282 # 82a8 <ustack_free+0x20f2>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	a5858593          	addi	a1,a1,-1448 # 82f8 <ustack_free+0x2142>
    ...
    58ba:	a9a58593          	addi	a1,a1,-1382 # 8350 <ustack_free+0x219a>
    ...
    58d0:	a7c58593          	addi	a1,a1,-1412 # 8348 <ustack_free+0x2192>
  ...
  int continuous = 0;
    ...
    58fc:	a0850513          	addi	a0,a0,-1528 # 8300 <ustack_free+0x214a>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	a0c50513          	addi	a0,a0,-1524 # 8330 <ustack_free+0x217a>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cae:	a1650513          	addi	a0,a0,-1514 # 86c0 <digits>
    5cb2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d7a:	94ab8b93          	addi	s7,s7,-1718 # 86c0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eba:	80290913          	addi	s2,s2,-2046 # 86b8 <ustack_free+0x2502>
        while(*s != 0){
...
00000000000060e0 <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
    60e0:	20000793          	li	a5,512
    60e4:	0ca7e763          	bltu	a5,a0,61b2 <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
    60e8:	1101                	addi	sp,sp,-32
    60ea:	ec06                	sd	ra,24(sp)
    60ec:	e822                	sd	s0,16(sp)
    60ee:	e426                	sd	s1,8(sp)
    60f0:	1000                	addi	s0,sp,32
    60f2:	84aa                	mv	s1,a0
        return (void*)-1;
    uint64 address;
    if(head == 0){
    60f4:	00003797          	auipc	a5,0x3
    60f8:	3647b783          	ld	a5,868(a5) # 9458 <head>
    60fc:	c7b1                	beqz	a5,6148 <ustack_malloc+0x68>
    ...
    60fe:	43d8                	lw	a4,4(a5)
    6100:	02051693          	slli	a3,a0,0x20
    6104:	9281                	srli	a3,a3,0x20
    6106:	06c1                	addi	a3,a3,16
    6108:	02071613          	slli	a2,a4,0x20
    610c:	9201                	srli	a2,a2,0x20
    610e:	06d66563          	bltu	a2,a3,6178 <ustack_malloc+0x98>
        else{
    ...
    6112:	0007e683          	lwu	a3,0(a5)
    6116:	01078613          	addi	a2,a5,16
    611a:	96b2                	add	a3,a3,a2
    611c:	00003617          	auipc	a2,0x3
    6120:	33c60613          	addi	a2,a2,828 # 9458 <head>
    6124:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
    6126:	3741                	addiw	a4,a4,-16
    6128:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
    612a:	c2d8                	sw	a4,4(a3)
            head->len = len;
    612c:	6218                	ld	a4,0(a2)
    612e:	c308                	sw	a0,0(a4)
            head->prev = next.prev;
    6130:	6218                	ld	a4,0(a2)
    6132:	e71c                	sd	a5,8(a4)
        }
    }
    return (void*)head + sizeof(struct ustack);
    6134:	00003517          	auipc	a0,0x3
    6138:	32453503          	ld	a0,804(a0) # 9458 <head>
    613c:	0541                	addi	a0,a0,16
}
    ...
    6148:	6505                	lui	a0,0x1
    614a:	00000097          	auipc	ra,0x0
    614e:	b04080e7          	jalr	-1276(ra) # 5c4e <sbrk>
        if(address == -1)//valid
    6152:	57fd                	li	a5,-1
    6154:	fef505e3          	beq	a0,a5,613e <ustack_malloc+0x5e>
        head = (struct ustack*) address;
    6158:	00003797          	auipc	a5,0x3
    615c:	30078793          	addi	a5,a5,768 # 9458 <head>
    6160:	e388                	sd	a0,0(a5)
        head->len = len;
    6162:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
    6164:	6398                	ld	a4,0(a5)
    6166:	6505                	lui	a0,0x1
    6168:	3541                	addiw	a0,a0,-16
    616a:	409504bb          	subw	s1,a0,s1
    616e:	c344                	sw	s1,4(a4)
        head->prev = 0;
    6170:	639c                	ld	a5,0(a5)
    6172:	0007b423          	sd	zero,8(a5)
    6176:	bf7d                	j	6134 <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
    6178:	6505                	lui	a0,0x1
    617a:	00000097          	auipc	ra,0x0
    617e:	ad4080e7          	jalr	-1324(ra) # 5c4e <sbrk>
            if(address == -1)//valid
    6182:	57fd                	li	a5,-1
    6184:	faf50de3          	beq	a0,a5,613e <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
    6188:	00003617          	auipc	a2,0x3
    618c:	2d060613          	addi	a2,a2,720 # 9458 <head>
    6190:	6218                	ld	a4,0(a2)
    6192:	435c                	lw	a5,4(a4)
    6194:	6685                	lui	a3,0x1
    6196:	36c1                	addiw	a3,a3,-16
    6198:	9fb5                	addw	a5,a5,a3
    619a:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
    619c:	00076683          	lwu	a3,0(a4)
    61a0:	01070593          	addi	a1,a4,16
    61a4:	96ae                	add	a3,a3,a1
    61a6:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
    61a8:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
    61aa:	621c                	ld	a5,0(a2)
    61ac:	e798                	sd	a4,8(a5)
            head->len = len;
    61ae:	c384                	sw	s1,0(a5)
    61b0:	b751                	j	6134 <ustack_malloc+0x54>
        return (void*)-1;
    61b2:	557d                	li	a0,-1
}
    61b4:	8082                	ret

00000000000061b6 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
    61b6:	00003797          	auipc	a5,0x3
    61ba:	2a27b783          	ld	a5,674(a5) # 9458 <head>
    61be:	cbad                	beqz	a5,6230 <ustack_free+0x7a>
int ustack_free(void){
    61c0:	1101                	addi	sp,sp,-32
    61c2:	ec06                	sd	ra,24(sp)
    61c4:	e822                	sd	s0,16(sp)
    61c6:	e426                	sd	s1,8(sp)
    61c8:	e04a                	sd	s2,0(sp)
    61ca:	1000                	addi	s0,sp,32
        return -1;
    }
    uint len = head->len;
    61cc:	4384                	lw	s1,0(a5)
    newHead = head->prev;
    61ce:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
    61d2:	02090d63          	beqz	s2,620c <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
    61d6:	03479713          	slli	a4,a5,0x34
    61da:	cf1d                	beqz	a4,6218 <ustack_free+0x62>
        sbrk(-4096);

    else if(PGROUNDUP((uint64)head) < (uint64)head + sizeof(struct ustack) + head->len)
    61dc:	6705                	lui	a4,0x1
    61de:	177d                	addi	a4,a4,-1
    61e0:	973e                	add	a4,a4,a5
    61e2:	76fd                	lui	a3,0xfffff
    61e4:	8f75                	and	a4,a4,a3
    61e6:	07c1                	addi	a5,a5,16
    61e8:	02049693          	slli	a3,s1,0x20
    61ec:	9281                	srli	a3,a3,0x20
    61ee:	97b6                	add	a5,a5,a3
    61f0:	02f76a63          	bltu	a4,a5,6224 <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
    61f4:	00003797          	auipc	a5,0x3
    61f8:	2727b223          	sd	s2,612(a5) # 9458 <head>
    return len;    
    61fc:	0004851b          	sext.w	a0,s1
    6200:	60e2                	ld	ra,24(sp)
    6202:	6442                	ld	s0,16(sp)
    6204:	64a2                	ld	s1,8(sp)
    6206:	6902                	ld	s2,0(sp)
    6208:	6105                	addi	sp,sp,32
    620a:	8082                	ret
        sbrk(-4096);
    620c:	757d                	lui	a0,0xfffff
    620e:	00000097          	auipc	ra,0x0
    6212:	a40080e7          	jalr	-1472(ra) # 5c4e <sbrk>
    6216:	bff9                	j	61f4 <ustack_free+0x3e>
        sbrk(-4096);
    6218:	757d                	lui	a0,0xfffff
    621a:	00000097          	auipc	ra,0x0
    621e:	a34080e7          	jalr	-1484(ra) # 5c4e <sbrk>
    6222:	bfc9                	j	61f4 <ustack_free+0x3e>
        sbrk(-PGSIZE);
    6224:	757d                	lui	a0,0xfffff
    6226:	00000097          	auipc	ra,0x0
    622a:	a28080e7          	jalr	-1496(ra) # 5c4e <sbrk>
    622e:	b7d9                	j	61f4 <ustack_free+0x3e>
        return -1;
    6230:	557d                	li	a0,-1
    6232:	8082                	ret
