...
main(int argc, char *argv[])
{
  ...
  2e:	956a0a13          	addi	s4,s4,-1706 # 980 <ustack_free+0x84>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	92058593          	addi	a1,a1,-1760 # 988 <ustack_free+0x8c>
  70:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	4dcb8b93          	addi	s7,s7,1244 # 998 <digits>
 ...
 600:	39490913          	addi	s2,s2,916 # 990 <ustack_free+0x94>
        while(*s != 0){
...
0000000000000826 <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 826:	20000793          	li	a5,512
 82a:	0ca7e763          	bltu	a5,a0,8f8 <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 ...
 83e:	7ce7b783          	ld	a5,1998(a5) # 1008 <head>
 842:	c7b1                	beqz	a5,88e <ustack_malloc+0x68>
 ...
 844:	43d8                	lw	a4,4(a5)
 846:	02051693          	slli	a3,a0,0x20
 84a:	9281                	srli	a3,a3,0x20
 84c:	06c1                	addi	a3,a3,16
 84e:	02071613          	slli	a2,a4,0x20
 852:	9201                	srli	a2,a2,0x20
 854:	06d66563          	bltu	a2,a3,8be <ustack_malloc+0x98>
        else{
 ...
 858:	0007e683          	lwu	a3,0(a5)
 85c:	01078613          	addi	a2,a5,16
 860:	96b2                	add	a3,a3,a2
 862:	00000617          	auipc	a2,0x0
 866:	7a660613          	addi	a2,a2,1958 # 1008 <head>
 86a:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 86c:	3741                	addiw	a4,a4,-16
 86e:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 870:	c2d8                	sw	a4,4(a3)
            head->len = len;
 872:	6218                	ld	a4,0(a2)
 ...
 87e:	78e53503          	ld	a0,1934(a0) # 1008 <head>
 ...
 894:	b04080e7          	jalr	-1276(ra) # 394 <sbrk>
        if(address == -1)//valid
 898:	57fd                	li	a5,-1
 89a:	fef505e3          	beq	a0,a5,884 <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 89e:	00000797          	auipc	a5,0x0
 8a2:	76a78793          	addi	a5,a5,1898 # 1008 <head>
 8a6:	e388                	sd	a0,0(a5)
        head->len = len;
 8a8:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 8aa:	6398                	ld	a4,0(a5)
 8ac:	6505                	lui	a0,0x1
 8ae:	3541                	addiw	a0,a0,-16
 8b0:	409504bb          	subw	s1,a0,s1
 8b4:	c344                	sw	s1,4(a4)
        head->prev = 0;
 8b6:	639c                	ld	a5,0(a5)
 8b8:	0007b423          	sd	zero,8(a5)
 8bc:	bf7d                	j	87a <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 8be:	6505                	lui	a0,0x1
 8c0:	00000097          	auipc	ra,0x0
 8c4:	ad4080e7          	jalr	-1324(ra) # 394 <sbrk>
            if(address == -1)//valid
 8c8:	57fd                	li	a5,-1
 8ca:	faf50de3          	beq	a0,a5,884 <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 8ce:	00000617          	auipc	a2,0x0
 8d2:	73a60613          	addi	a2,a2,1850 # 1008 <head>
 8d6:	6218                	ld	a4,0(a2)
 8d8:	435c                	lw	a5,4(a4)
 8da:	6685                	lui	a3,0x1
 8dc:	36c1                	addiw	a3,a3,-16
 8de:	9fb5                	addw	a5,a5,a3
 8e0:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 8e2:	00076683          	lwu	a3,0(a4)
 8e6:	01070593          	addi	a1,a4,16
 8ea:	96ae                	add	a3,a3,a1
 8ec:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
 8ee:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
 ...
 8f2:	e798                	sd	a4,8(a5)
            head->len = len;
 8f4:	c384                	sw	s1,0(a5)
 8f6:	b751                	j	87a <ustack_malloc+0x54>
        return (void*)-1;
 8f8:	557d                	li	a0,-1
}
 8fa:	8082                	ret

00000000000008fc <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 8fc:	00000797          	auipc	a5,0x0
 900:	70c7b783          	ld	a5,1804(a5) # 1008 <head>
 904:	cbad                	beqz	a5,976 <ustack_free+0x7a>
int ustack_free(void){
 ...
 912:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 914:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 918:	02090d63          	beqz	s2,952 <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 91c:	03479713          	slli	a4,a5,0x34
 920:	cf1d                	beqz	a4,95e <ustack_free+0x62>
        sbrk(-4096);
 ...
 928:	76fd                	lui	a3,0xfffff
 92a:	8f75                	and	a4,a4,a3
 92c:	07c1                	addi	a5,a5,16
 92e:	02049693          	slli	a3,s1,0x20
 932:	9281                	srli	a3,a3,0x20
 934:	97b6                	add	a5,a5,a3
 936:	02f76a63          	bltu	a4,a5,96a <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 93a:	00000797          	auipc	a5,0x0
 93e:	6d27b723          	sd	s2,1742(a5) # 1008 <head>
    return len;    
 942:	0004851b          	sext.w	a0,s1
 ...
 958:	a40080e7          	jalr	-1472(ra) # 394 <sbrk>
 95c:	bff9                	j	93a <ustack_free+0x3e>
        sbrk(-4096);
 95e:	757d                	lui	a0,0xfffff
 960:	00000097          	auipc	ra,0x0
 964:	a34080e7          	jalr	-1484(ra) # 394 <sbrk>
 968:	bfc9                	j	93a <ustack_free+0x3e>
        sbrk(-PGSIZE);
 96a:	757d                	lui	a0,0xfffff
 96c:	00000097          	auipc	ra,0x0
 970:	a28080e7          	jalr	-1496(ra) # 394 <sbrk>
 974:	b7d9                	j	93a <ustack_free+0x3e>
        return -1;
 976:	557d                	li	a0,-1
 978:	8082                	ret
