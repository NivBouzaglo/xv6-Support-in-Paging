...
00000000000001de <main>:
{
 ...
 252:	95258593          	addi	a1,a1,-1710 # ba0 <ustack_free+0x8a>
 256:	4509                	li	a0,2
 ...
 288:	93c50513          	addi	a0,a0,-1732 # bc0 <ustack_free+0xaa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 60e:	5d650513          	addi	a0,a0,1494 # be0 <digits>
 612:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6da:	50ab8b93          	addi	s7,s7,1290 # be0 <digits>
 ...
 81a:	3c290913          	addi	s2,s2,962 # bd8 <ustack_free+0xc2>
        while(*s != 0){
...
0000000000000a40 <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 a40:	20000793          	li	a5,512
 a44:	0ca7e763          	bltu	a5,a0,b12 <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 a48:	1101                	addi	sp,sp,-32
 ...
 a58:	5b47b783          	ld	a5,1460(a5) # 1008 <head>
 a5c:	c7b1                	beqz	a5,aa8 <ustack_malloc+0x68>
 ...
 a5e:	43d8                	lw	a4,4(a5)
 a60:	02051693          	slli	a3,a0,0x20
 a64:	9281                	srli	a3,a3,0x20
 a66:	06c1                	addi	a3,a3,16
 a68:	02071613          	slli	a2,a4,0x20
 a6c:	9201                	srli	a2,a2,0x20
 a6e:	06d66563          	bltu	a2,a3,ad8 <ustack_malloc+0x98>
        else{
 ...
 a72:	0007e683          	lwu	a3,0(a5)
 a76:	01078613          	addi	a2,a5,16
 a7a:	96b2                	add	a3,a3,a2
 a7c:	00000617          	auipc	a2,0x0
 a80:	58c60613          	addi	a2,a2,1420 # 1008 <head>
 a84:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 a86:	3741                	addiw	a4,a4,-16
 a88:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 a8a:	c2d8                	sw	a4,4(a3)
            head->len = len;
 a8c:	6218                	ld	a4,0(a2)
 ...
 a98:	57453503          	ld	a0,1396(a0) # 1008 <head>
 ...
 aae:	b04080e7          	jalr	-1276(ra) # 5ae <sbrk>
        if(address == -1)//valid
 ab2:	57fd                	li	a5,-1
 ab4:	fef505e3          	beq	a0,a5,a9e <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 ab8:	00000797          	auipc	a5,0x0
 abc:	55078793          	addi	a5,a5,1360 # 1008 <head>
 ac0:	e388                	sd	a0,0(a5)
        head->len = len;
 ac2:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 ac4:	6398                	ld	a4,0(a5)
 ac6:	6505                	lui	a0,0x1
 ac8:	3541                	addiw	a0,a0,-16
 aca:	409504bb          	subw	s1,a0,s1
 ace:	c344                	sw	s1,4(a4)
        head->prev = 0;
 ad0:	639c                	ld	a5,0(a5)
 ad2:	0007b423          	sd	zero,8(a5)
 ad6:	bf7d                	j	a94 <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 ad8:	6505                	lui	a0,0x1
 ada:	00000097          	auipc	ra,0x0
 ade:	ad4080e7          	jalr	-1324(ra) # 5ae <sbrk>
            if(address == -1)//valid
 ae2:	57fd                	li	a5,-1
 ae4:	faf50de3          	beq	a0,a5,a9e <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 ae8:	00000617          	auipc	a2,0x0
 aec:	52060613          	addi	a2,a2,1312 # 1008 <head>
 af0:	6218                	ld	a4,0(a2)
 af2:	435c                	lw	a5,4(a4)
 af4:	6685                	lui	a3,0x1
 af6:	36c1                	addiw	a3,a3,-16
 af8:	9fb5                	addw	a5,a5,a3
 afa:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 afc:	00076683          	lwu	a3,0(a4)
 b00:	01070593          	addi	a1,a4,16
 b04:	96ae                	add	a3,a3,a1
 b06:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
 b08:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
 ...
 b0c:	e798                	sd	a4,8(a5)
            head->len = len;
 b0e:	c384                	sw	s1,0(a5)
 b10:	b751                	j	a94 <ustack_malloc+0x54>
        return (void*)-1;
 b12:	557d                	li	a0,-1
}
 b14:	8082                	ret

0000000000000b16 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 b16:	00000797          	auipc	a5,0x0
 b1a:	4f27b783          	ld	a5,1266(a5) # 1008 <head>
 b1e:	cbad                	beqz	a5,b90 <ustack_free+0x7a>
int ustack_free(void){
 ...
 b2c:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 b2e:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 b32:	02090d63          	beqz	s2,b6c <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 b36:	03479713          	slli	a4,a5,0x34
 b3a:	cf1d                	beqz	a4,b78 <ustack_free+0x62>
        sbrk(-4096);
 ...
 b42:	76fd                	lui	a3,0xfffff
 b44:	8f75                	and	a4,a4,a3
 b46:	07c1                	addi	a5,a5,16
 b48:	02049693          	slli	a3,s1,0x20
 b4c:	9281                	srli	a3,a3,0x20
 b4e:	97b6                	add	a5,a5,a3
 b50:	02f76a63          	bltu	a4,a5,b84 <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 b54:	00000797          	auipc	a5,0x0
 b58:	4b27ba23          	sd	s2,1204(a5) # 1008 <head>
    return len;    
 b5c:	0004851b          	sext.w	a0,s1
 ...
 b6a:	8082                	ret
        sbrk(-4096);
 b6c:	757d                	lui	a0,0xfffff
 b6e:	00000097          	auipc	ra,0x0
 b72:	a40080e7          	jalr	-1472(ra) # 5ae <sbrk>
 b76:	bff9                	j	b54 <ustack_free+0x3e>
        sbrk(-4096);
 b78:	757d                	lui	a0,0xfffff
 b7a:	00000097          	auipc	ra,0x0
 b7e:	a34080e7          	jalr	-1484(ra) # 5ae <sbrk>
 b82:	bfc9                	j	b54 <ustack_free+0x3e>
        sbrk(-PGSIZE);
 b84:	757d                	lui	a0,0xfffff
 b86:	00000097          	auipc	ra,0x0
 b8a:	a28080e7          	jalr	-1496(ra) # 5ae <sbrk>
 b8e:	b7d9                	j	b54 <ustack_free+0x3e>
        return -1;
 b90:	557d                	li	a0,-1
 b92:	8082                	ret
