...
main(void)
{
  ...
  12:	9e250513          	addi	a0,a0,-1566 # 9f0 <ustack_free+0x80>
  ...
  3a:	9c290913          	addi	s2,s2,-1598 # 9f8 <ustack_free+0x88>
  3e:	854a                	mv	a0,s2
  ...
  6e:	9de50513          	addi	a0,a0,-1570 # a48 <ustack_free+0xd8>
  ...
  8c:	96850513          	addi	a0,a0,-1688 # 9f0 <ustack_free+0x80>
  90:	00000097          	auipc	ra,0x0
  94:	338080e7          	jalr	824(ra) # 3c8 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	95650513          	addi	a0,a0,-1706 # 9f0 <ustack_free+0x80>
  a2:	00000097          	auipc	ra,0x0
  a6:	31e080e7          	jalr	798(ra) # 3c0 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	96450513          	addi	a0,a0,-1692 # a10 <ustack_free+0xa0>
  ...
  d2:	95a50513          	addi	a0,a0,-1702 # a28 <ustack_free+0xb8>
  d6:	00000097          	auipc	ra,0x0
  da:	2e2080e7          	jalr	738(ra) # 3b8 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	95250513          	addi	a0,a0,-1710 # a30 <ustack_free+0xc0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 468:	60c50513          	addi	a0,a0,1548 # a70 <digits>
 46c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 534:	540b8b93          	addi	s7,s7,1344 # a70 <digits>
 ...
 674:	3f890913          	addi	s2,s2,1016 # a68 <ustack_free+0xf8>
        while(*s != 0){
...
000000000000089a <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 89a:	20000793          	li	a5,512
 89e:	0ca7e763          	bltu	a5,a0,96c <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 ...
 8b2:	76a7b783          	ld	a5,1898(a5) # 1018 <head>
 8b6:	c7b1                	beqz	a5,902 <ustack_malloc+0x68>
 ...
 8b8:	43d8                	lw	a4,4(a5)
 8ba:	02051693          	slli	a3,a0,0x20
 8be:	9281                	srli	a3,a3,0x20
 8c0:	06c1                	addi	a3,a3,16
 8c2:	02071613          	slli	a2,a4,0x20
 8c6:	9201                	srli	a2,a2,0x20
 8c8:	06d66563          	bltu	a2,a3,932 <ustack_malloc+0x98>
        else{
 ...
 8cc:	0007e683          	lwu	a3,0(a5)
 8d0:	01078613          	addi	a2,a5,16
 8d4:	96b2                	add	a3,a3,a2
 8d6:	00000617          	auipc	a2,0x0
 8da:	74260613          	addi	a2,a2,1858 # 1018 <head>
 8de:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 8e0:	3741                	addiw	a4,a4,-16
 8e2:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 8e4:	c2d8                	sw	a4,4(a3)
            head->len = len;
 8e6:	6218                	ld	a4,0(a2)
 ...
 8f2:	72a53503          	ld	a0,1834(a0) # 1018 <head>
 ...
 908:	b04080e7          	jalr	-1276(ra) # 408 <sbrk>
        if(address == -1)//valid
 90c:	57fd                	li	a5,-1
 90e:	fef505e3          	beq	a0,a5,8f8 <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 912:	00000797          	auipc	a5,0x0
 916:	70678793          	addi	a5,a5,1798 # 1018 <head>
 91a:	e388                	sd	a0,0(a5)
        head->len = len;
 91c:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 91e:	6398                	ld	a4,0(a5)
 920:	6505                	lui	a0,0x1
 922:	3541                	addiw	a0,a0,-16
 924:	409504bb          	subw	s1,a0,s1
 928:	c344                	sw	s1,4(a4)
        head->prev = 0;
 92a:	639c                	ld	a5,0(a5)
 92c:	0007b423          	sd	zero,8(a5)
 930:	bf7d                	j	8ee <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 932:	6505                	lui	a0,0x1
 934:	00000097          	auipc	ra,0x0
 938:	ad4080e7          	jalr	-1324(ra) # 408 <sbrk>
            if(address == -1)//valid
 93c:	57fd                	li	a5,-1
 93e:	faf50de3          	beq	a0,a5,8f8 <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 942:	00000617          	auipc	a2,0x0
 946:	6d660613          	addi	a2,a2,1750 # 1018 <head>
 94a:	6218                	ld	a4,0(a2)
 94c:	435c                	lw	a5,4(a4)
 94e:	6685                	lui	a3,0x1
 950:	36c1                	addiw	a3,a3,-16
 952:	9fb5                	addw	a5,a5,a3
 954:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 956:	00076683          	lwu	a3,0(a4)
 95a:	01070593          	addi	a1,a4,16
 ...
 966:	e798                	sd	a4,8(a5)
            head->len = len;
 968:	c384                	sw	s1,0(a5)
 96a:	b751                	j	8ee <ustack_malloc+0x54>
        return (void*)-1;
 96c:	557d                	li	a0,-1
}
 96e:	8082                	ret

0000000000000970 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 970:	00000797          	auipc	a5,0x0
 974:	6a87b783          	ld	a5,1704(a5) # 1018 <head>
 978:	cbad                	beqz	a5,9ea <ustack_free+0x7a>
int ustack_free(void){
 ...
 986:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 988:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 98c:	02090d63          	beqz	s2,9c6 <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 990:	03479713          	slli	a4,a5,0x34
 994:	cf1d                	beqz	a4,9d2 <ustack_free+0x62>
        sbrk(-4096);
 ...
 99c:	76fd                	lui	a3,0xfffff
 99e:	8f75                	and	a4,a4,a3
 9a0:	07c1                	addi	a5,a5,16
 9a2:	02049693          	slli	a3,s1,0x20
 9a6:	9281                	srli	a3,a3,0x20
 9a8:	97b6                	add	a5,a5,a3
 9aa:	02f76a63          	bltu	a4,a5,9de <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 9ae:	00000797          	auipc	a5,0x0
 9b2:	6727b523          	sd	s2,1642(a5) # 1018 <head>
    return len;    
 9b6:	0004851b          	sext.w	a0,s1
 ...
 9c4:	8082                	ret
        sbrk(-4096);
 9c6:	757d                	lui	a0,0xfffff
 9c8:	00000097          	auipc	ra,0x0
 9cc:	a40080e7          	jalr	-1472(ra) # 408 <sbrk>
 9d0:	bff9                	j	9ae <ustack_free+0x3e>
        sbrk(-4096);
 9d2:	757d                	lui	a0,0xfffff
 9d4:	00000097          	auipc	ra,0x0
 9d8:	a34080e7          	jalr	-1484(ra) # 408 <sbrk>
 9dc:	bfc9                	j	9ae <ustack_free+0x3e>
        sbrk(-PGSIZE);
 9de:	757d                	lui	a0,0xfffff
 9e0:	00000097          	auipc	ra,0x0
 9e4:	a28080e7          	jalr	-1496(ra) # 408 <sbrk>
 9e8:	b7d9                	j	9ae <ustack_free+0x3e>
        return -1;
 9ea:	557d                	li	a0,-1
 9ec:	8082                	ret
