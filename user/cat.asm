...
cat(int fd)
{
  ...
  44:	9e058593          	addi	a1,a1,-1568 # a20 <ustack_free+0x8a>
  48:	4509                	li	a0,2
  ...
  72:	9ca58593          	addi	a1,a1,-1590 # a38 <ustack_free+0xa2>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	94e58593          	addi	a1,a1,-1714 # a50 <ustack_free+0xba>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48e:	5e650513          	addi	a0,a0,1510 # a70 <digits>
 492:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 55a:	51ab8b93          	addi	s7,s7,1306 # a70 <digits>
 ...
 69a:	3d290913          	addi	s2,s2,978 # a68 <ustack_free+0xd2>
        while(*s != 0){
...
00000000000008c0 <ustack_malloc>:
...
void* ustack_malloc(uint len){
    ...
    if(len > 512) //valid
 8c0:	20000793          	li	a5,512
 8c4:	0ca7e763          	bltu	a5,a0,992 <ustack_malloc+0xd2>
void* ustack_malloc(uint len){
 ...
 8d8:	7347b783          	ld	a5,1844(a5) # 1008 <head>
 8dc:	c7b1                	beqz	a5,928 <ustack_malloc+0x68>
 ...
 8de:	43d8                	lw	a4,4(a5)
 8e0:	02051693          	slli	a3,a0,0x20
 8e4:	9281                	srli	a3,a3,0x20
 8e6:	06c1                	addi	a3,a3,16
 8e8:	02071613          	slli	a2,a4,0x20
 8ec:	9201                	srli	a2,a2,0x20
 8ee:	06d66563          	bltu	a2,a3,958 <ustack_malloc+0x98>
        else{
 ...
 8f2:	0007e683          	lwu	a3,0(a5)
 8f6:	01078613          	addi	a2,a5,16
 8fa:	96b2                	add	a3,a3,a2
 8fc:	00000617          	auipc	a2,0x0
 900:	70c60613          	addi	a2,a2,1804 # 1008 <head>
 904:	e214                	sd	a3,0(a2)
            next.pa = head->pa - len - sizeof(struct ustack);
 906:	3741                	addiw	a4,a4,-16
 908:	9f09                	subw	a4,a4,a0
            head->pa = next.pa;
 90a:	c2d8                	sw	a4,4(a3)
            head->len = len;
 90c:	6218                	ld	a4,0(a2)
 ...
 918:	6f453503          	ld	a0,1780(a0) # 1008 <head>
 ...
 92e:	b04080e7          	jalr	-1276(ra) # 42e <sbrk>
        if(address == -1)//valid
 932:	57fd                	li	a5,-1
 934:	fef505e3          	beq	a0,a5,91e <ustack_malloc+0x5e>
        head = (struct ustack*) address;
 938:	00000797          	auipc	a5,0x0
 93c:	6d078793          	addi	a5,a5,1744 # 1008 <head>
 940:	e388                	sd	a0,0(a5)
        head->len = len;
 942:	c104                	sw	s1,0(a0)
        head->pa = 4096 - sizeof(struct ustack) - len;
 944:	6398                	ld	a4,0(a5)
 946:	6505                	lui	a0,0x1
 948:	3541                	addiw	a0,a0,-16
 94a:	409504bb          	subw	s1,a0,s1
 94e:	c344                	sw	s1,4(a4)
        head->prev = 0;
 950:	639c                	ld	a5,0(a5)
 952:	0007b423          	sd	zero,8(a5)
 956:	bf7d                	j	914 <ustack_malloc+0x54>
            address = (uint64)sbrk(4096);
 958:	6505                	lui	a0,0x1
 95a:	00000097          	auipc	ra,0x0
 95e:	ad4080e7          	jalr	-1324(ra) # 42e <sbrk>
            if(address == -1)//valid
 962:	57fd                	li	a5,-1
 964:	faf50de3          	beq	a0,a5,91e <ustack_malloc+0x5e>
            next.pa = 4096-sizeof(struct ustack) - (len - head->pa);
 968:	00000617          	auipc	a2,0x0
 96c:	6a060613          	addi	a2,a2,1696 # 1008 <head>
 970:	6218                	ld	a4,0(a2)
 972:	435c                	lw	a5,4(a4)
 974:	6685                	lui	a3,0x1
 976:	36c1                	addiw	a3,a3,-16
 978:	9fb5                	addw	a5,a5,a3
 97a:	9f85                	subw	a5,a5,s1
            head = (struct ustack*)((uint64)head + sizeof(struct ustack) + head->len );
 97c:	00076683          	lwu	a3,0(a4)
 980:	01070593          	addi	a1,a4,16
 984:	96ae                	add	a3,a3,a1
 986:	e214                	sd	a3,0(a2)
            head->pa = next.pa;
 988:	c2dc                	sw	a5,4(a3)
            head->prev = next.prev;
 ...
 98c:	e798                	sd	a4,8(a5)
            head->len = len;
 98e:	c384                	sw	s1,0(a5)
 990:	b751                	j	914 <ustack_malloc+0x54>
        return (void*)-1;
 992:	557d                	li	a0,-1
}
 994:	8082                	ret

0000000000000996 <ustack_free>:

int ustack_free(void){
    struct ustack* newHead;
    if(head == 0){
 996:	00000797          	auipc	a5,0x0
 99a:	6727b783          	ld	a5,1650(a5) # 1008 <head>
 99e:	cbad                	beqz	a5,a10 <ustack_free+0x7a>
int ustack_free(void){
 ...
 9ac:	4384                	lw	s1,0(a5)
    newHead = head->prev;
 9ae:	0087b903          	ld	s2,8(a5)
    if(head->prev == 0)
 9b2:	02090d63          	beqz	s2,9ec <ustack_free+0x56>
        sbrk(-4096);

    else if(PGROUNDDOWN((uint64)head) == (uint64)head)
 9b6:	03479713          	slli	a4,a5,0x34
 9ba:	cf1d                	beqz	a4,9f8 <ustack_free+0x62>
        sbrk(-4096);

    else if(PGROUNDUP((uint64)head) < (uint64)head + sizeof(struct ustack) + head->len)
 9bc:	6705                	lui	a4,0x1
 9be:	177d                	addi	a4,a4,-1
 9c0:	973e                	add	a4,a4,a5
 9c2:	76fd                	lui	a3,0xfffff
 9c4:	8f75                	and	a4,a4,a3
 9c6:	07c1                	addi	a5,a5,16
 9c8:	02049693          	slli	a3,s1,0x20
 9cc:	9281                	srli	a3,a3,0x20
 9ce:	97b6                	add	a5,a5,a3
 9d0:	02f76a63          	bltu	a4,a5,a04 <ustack_free+0x6e>
        sbrk(-PGSIZE);

    head = newHead;
 9d4:	00000797          	auipc	a5,0x0
 9d8:	6327ba23          	sd	s2,1588(a5) # 1008 <head>
    return len;    
 9dc:	0004851b          	sext.w	a0,s1
 ...
 9ea:	8082                	ret
        sbrk(-4096);
 9ec:	757d                	lui	a0,0xfffff
 9ee:	00000097          	auipc	ra,0x0
 9f2:	a40080e7          	jalr	-1472(ra) # 42e <sbrk>
 9f6:	bff9                	j	9d4 <ustack_free+0x3e>
        sbrk(-4096);
 9f8:	757d                	lui	a0,0xfffff
 9fa:	00000097          	auipc	ra,0x0
 9fe:	a34080e7          	jalr	-1484(ra) # 42e <sbrk>
 a02:	bfc9                	j	9d4 <ustack_free+0x3e>
        sbrk(-PGSIZE);
 a04:	757d                	lui	a0,0xfffff
 a06:	00000097          	auipc	ra,0x0
 a0a:	a28080e7          	jalr	-1496(ra) # 42e <sbrk>
 a0e:	b7d9                	j	9d4 <ustack_free+0x3e>
        return -1;
 a10:	557d                	li	a0,-1
 a12:	8082                	ret
